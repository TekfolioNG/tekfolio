        ...
        <div class="container mx-auto px-4 md:px-8 lg:px-12 relative z-10">
            ...
            <div class="mb-16 md:mb-20">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 max-w-7xl mx-auto">
                    <div
                        class="bg-white rounded-xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-500 hover:border-[#4D7EFF]/20 group text-center">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center gap-3 md:gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-[#4D7EFF] text-xs md:text-sm font-medium mt-1">{{
