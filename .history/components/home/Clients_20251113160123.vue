            ...
            <div class="mb-12 md:mb-16">
                ...
                <div class="text-center mb-6">
                    <div class="inline-flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-full">
                        ...
                        <span class="text-[#4D7EFF] font-semibold text-xs sm:text-sm uppercase tracking-wide">Success Stories</span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-6xl mx-auto">
                    ...
                    <div class="order-2 lg:order-2">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl hover:shadow-3xl transition-shadow duration-300">
                            <img src="/assets/img/book-author-LiteraForge.jpg" 
                                 alt="Book Author Success Story"
