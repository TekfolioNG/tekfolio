<template>
    <section class="relative w-full bg-white">
        ...
        <div class="w-full relative bg-gradient-to-r from-purple-700 to-blue-600 py-1">

            <div class="max-w-7xl mx-auto px-8 md:px-12 lg:px-16">

                <!-- White content box with margins showing gradient edges -->
                <div class="bg-gray-100 py-12 md:py-16 lg:py-20 px-6 md:px-10 lg:px-12">
                        ...
                        <div class="lg:col-span-9">
                            <Transition name="fade" mode="out-in">
                                <div :key="currentTestimonial" class="relative">
                                    <svg class="absolute -top-4 -left-2 w-10 h-10 text-purple-200 opacity-40"
