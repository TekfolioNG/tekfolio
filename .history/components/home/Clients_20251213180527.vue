<template>
    <section class="relative w-full bg-white">
        ...
        <div class="w-full py-12 md:py-16 text-center">
            <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
                <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold leading-tight">
                    <span class="text-gray-900">Trusted by Forward-Thinking </span>
        ...
        <div class="w-full relative bg-gradient-to-r from-purple-900/95 to-blue-900/95 border-purple-700/30 py-1">

            <div class="max-w-7xl mx-auto px-8 md:px-12 lg:px-16">

                <!-- Dark content box with margins showing gradient edges -->
                <div class="bg-gray-900 pt-16 pb-12 md:pt-20 md:pb-16 lg:pt-24 lg:pb-20 px-6 md:px-10 lg:px-12">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                        ...
                        <div class="lg:col-span-3 text-center lg:text-left">
                            <Transition name="fade" mode="out-in">
                                <div :key="currentTestimonial" class="space-y-2">
                        ...
                        <div class="lg:col-span-9">
                            <Transition name="fade" mode="out-in">
                                <div :key="currentTestimonial" class="relative">
                                    <svg class="absolute -top-4 -left-2 w-10 h-10 text-purple-400 opacity-40"
                                        fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                                    </svg>
                                    <p
                                        class="text-lg md:text-xl lg:text-2xl text-gray-100 leading-relaxed pl-8 font-normal">
                    ...
                    <div class="w-full pt-12 md:pt-16 overflow-hidden border-t border-gray-700 mt-12 md:mt-16">
