                        ...
                        <div class="lg:col-span-3 text-center lg:text-left">
                            <Transition name="fade" mode="out-in">
                                <div :key="currentTestimonial" class="space-y-3">
                                    ...
                                    <div class="flex gap-2 justify-center lg:justify-start pt-2">
                                        <div v-for="(testimonial, index) in testimonials" :key="index"
                                            class="indicator-dot" :class="{ 'active': index === currentTestimonial }">
                                        </div>
                                    </div>
                                </div>
                            </Transition>
...
/* Testimonial fade transitions - slower and subtler */
.fade-enter-active,
.fade-leave-active {
