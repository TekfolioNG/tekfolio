                ...
                <div
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                        ...
                        <div class="lg:col-span-9">
                            <div class="relative">
                                <svg class="absolute -top-4 -left-2 w-10 h-10 text-purple-300 opacity-40"
...
const testimonials = [
    {
        ...
        quote: "What sets Tekfolio apart is their ability to move fast without cutting corners. Clean code, clear communication. More importantly, their service delivery was without question swift and exceptional."
    },
    {
        name: "Sarah Mitchell",
