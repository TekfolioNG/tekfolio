<template>
    <section class="relative w-full bg-gradient-to-b from-white to-gray-200">
        ...
        <div class="w-full relative bg-gradient-to-r from-purple-900/95 to-blue-900/95 border-purple-700/30 pt-1 pb-8 md:pb-12">

            <div class="max-w-7xl mx-auto px-8 md:px-12 lg:px-16">

                <!-- Light content box extending beyond gradient at top -->
                <div class="bg-gradient-to-b from-white to-gray-200 pt-20 pb-12 md:pt-24 md:pb-16 lg:pt-28 lg:pb-20 px-6 md:px-10 lg:px-12 -mt-6 md:-mt-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                        ...
                        <div class="lg:col-span-9">
                            <div class="relative">
                                <svg class="absolute -top-4 -left-2 w-10 h-10 text-purple-300 opacity-25"
                                    fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                        d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
                                </svg>
                                <p
                                    class="text-lg md:text-xl lg:text-2xl text-gray-900 leading-relaxed pl-8 font-normal">
