...
const testimonials = [
    {
        ...
        quote: "I really love the fact that Tekfolio always moves fast without cutting corners. Clean code, clear communication, and realistic deadlines. More importantly, their service delivery was without question swift and exceptional."
    },
    {
...
const clientLogos = [
    { name: "EcoPlatinum", src: ecoplatinum, url: "https://ecoplatinum.com" },
    { name: "LiteraForge", src: literaforge, url: "https://literaforge.com" },
    { name: "PetaBiz", src: petabiz, url: "https://petabiz.com" },
    { name: "PPIL", src: ppil, url: "https://ppil.com" },
    { name: "Syntanium", src: syntanium, url: "https://syntanium.com" },
    { name: "VeraVerde", src: veraverde, url: "https://veraverde.com" },
    { name: "Wilson & Samson", src: wilsonsamson, url: "https://wilsonsamson.com" },
    { name: "Xstrato", src: xstrato, url: "https://xstrato.com" }, { name: "Akorite", src: akorite, url: "https://akorite.com" }
];
