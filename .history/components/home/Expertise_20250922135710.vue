            ...
            <div class="grid grid-cols-1 md:grid-cols-4">
                ...
                <div class="flex flex-col items-center text-center p-8 md:p-10">
                    <div class="mb-8">
                        ...
                        <p class="text-gray-900 dark:text-gray-400 leading-relaxed font-barlow-thin">
                            Rooted in downstream operations, we deliver safe, reliable, and sustainable refining and
                            distribution solutions while also supporting upstream and midstream players with technical
