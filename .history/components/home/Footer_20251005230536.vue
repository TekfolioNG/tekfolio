      ...
      <div class="bg-gray-950 -mx-4 sm:-mx-6 lg:-mx-8 px-4 -my-6 sm:px-6 lg:px-8 border-t border-gray-700 pt-6 pb-6">
        <div
          ...
          <div class="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
            <button @click="showPrivacyPolicy = true">Privacy Policy</button>
            <button @click="showTermsOfService = true">Terms of Service</button>
...
<script setup>
import { ref } from 'vue'
import TermsOfServiceModal from '~/components/HHomeTermsOfServiceModal.vue'
import PrivacyPolicyModal from '~/components/HomePrivacyPolicyModal.vue'
