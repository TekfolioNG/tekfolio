<template>
  <footer class="bg-[#012430] text-white pt-16 pb-8">
        ...
        <div>
          ...
          <div class="flex space-x-4 justify-center md:justify-start">
            ...
            <a href="https://wa.me/2349026944592" target="_blank" rel="noopener noreferrer"
              class="text-gray-400 hover:text-[#25D366] transition-colors duration-200">
              <FontAwesomeIcon :icon="['fab', 'whatsapp']" style="width: 24px; height: 24px;" />
            </a>
          </div>
        </div>
    ...
    <a href="https://wa.me/2349026944592" target="_blank" rel="noopener noreferrer"
      class="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:bg-[#20BA5A] hover:scale-110 transition-all duration-300 group">
      <FontAwesomeIcon :icon="['fab', 'whatsapp']" style="width: 28px; height: 28px; color: white;" />
      <span
