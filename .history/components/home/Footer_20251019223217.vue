<template>
  <footer class="bg-[#012430] text-white pt-16 pb-8">
    ...
    <a href="https://wa.me/2349026944592" target="_blank" rel="noopener noreferrer"
      class="fixed bottom-6 right-6 z-50 bg-white p-4 rounded-full shadow-2xl hover:scale-110 transition-all duration-300 group">
      <img src="/assets/img/whatsapp.png" alt="WhatsApp" class="w-8 h-8" />
      <span
        class="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-gray-900 text-[#25D366] px-3 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
