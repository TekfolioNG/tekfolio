<template>
  <footer class="bg-[#012430] text-white pt-16 pb-8">
    ...
    <a href="https://wa.me/2349026944592" target="_blank" rel="noopener noreferrer"
      ...
      <img src="/assets/img/whatsapp.png" alt="WhatsApp" class="w-6 h-6" />
      <span
        class="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-g[#25D366] text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
