      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 text-center md:text-left">
        ...
        <div>
          ...
          <p class="text-gray-300 mb-6 max-w-md mx-auto md:mx-0">
            We craft compelling narratives and strategic content that transforms ideas into impactful stories and
            business success.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li class="flex items-start justify-center md:justify-start">
              ...
              <span class="text-gray-300 text-left">11 Adeshina Street, Off Olowu Street,<br>Off Obafemi Awolowo
                Way,<br>Ikeja, Lagos</span>
            </li>
            <li class="flex items-center justify-center md:justify-start">
              <Icon name="lucide:phone" class="w-5 h-5 mr-3 text-[#4D7EFF] flex-shrink-0" />
              <span class="text-gray-300">+234 813 292 4637<br>+234 813 292 4637</span>
            </li>
            <li class="flex items-center justify-center md:justify-start">
