<template>
  <footer class="bg-gray-900 text-gray-300">
    ...
    <div class="bg-gradient-to-r from-purple-900/95 to-blue-900/95 border-b border-purple-700/30">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          ...
          <div class="mb-8 lg:mb-0">
            ...
            <div class="mt-4 space-y-2">
              <p class="text-gray-300">77 Awolowo Road, MAN House</p>
              <p class="text-gray-300">Ikeja, Lagos</p>
      ...
      <div class="border-t border-gray-800 pt-12 pb-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="flex items-start space-x-4">
            ...
            <div>
              <h4 class="text-white font-semibold mb-2">Get Started with Digital Excellence</h4>
              <p class="text-gray-400 text-sm mb-3">Get instant access to professional development services tailored for
                your business.</p>
              <NuxtLink to="/contact"
