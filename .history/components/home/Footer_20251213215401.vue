  ...
  <footer class="bg-gray-900 text-gray-300">
    ...
    <div class="border-b border-gray-800">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <h3 class="text-white font-semibold mb-8 text-xl lg:text-2xl text-center">Get Started with Digital Excellence
        </h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="flex items-start space-x-4">
            ...
            <div>
              ...
              <p class="text-gray-400 text-sm mb-3">Discuss your project with our experts and get tailored solutions for
    ...
    <!-- Main Footer Content -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      <!-- Logo, Address, and Contact Section -->
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
        <!-- Logo and Address -->
        <div>
          <NuxtLink to="/" class="inline-block mb-6">
            <img src="/tekfolio.svg" alt="Tekfolio Logo" class="h-10 lg:h-12" />
          </NuxtLink>
          <div class="space-y-3">
        ...
        <div class="space-y-6">
          <div class="space-y-3">
            <p class="text-gray-300">
              ...
              <a href="tel:+2347088547450" class="hover:text-white transition-colors ml-2">
                +234 708 854 7450
              </a>
            </p>
            <p class="text-gray-300">
              <span class="text-gray-400">Email:</span>
              <a href="mailto:hello@tekfolio.ng" class="hover:text-white transition-colors ml-2">
                hello@tekfolio.ng
              </a>
            </p>
          </div>
          ...
          <!-- Navigation Links -->
          <div class="grid grid-cols-2 md:grid-cols-3 gap-8 pt-6 border-t border-gray-800">
            <!-- Solutions Column -->
            <div>
    ...
    <button @click="scrollToTop"
      class="fixed bottom-6 right-6 p-3 bg-gray-800 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-40"
