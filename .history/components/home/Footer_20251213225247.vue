<template>
  <footer class="bg-gray-900 text-gray-300">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      ...
      <!-- Top Section: Logo, Address, and Navigation -->
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 lg:flex lg:justify-between lg:gap-0">

        <!-- Logo and Address -->
        <div class="space-y-6 text-center md:text-left lg:flex-1">
          <!-- Logo -->
          <NuxtLink to="/" class="inline-block">
            <img src="/tekfolio.svg" alt="Tekfolio Logo" class="h-12 lg:h-14 mx-auto md:mx-0" />
          </NuxtLink>
