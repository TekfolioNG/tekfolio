        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div
            ...
            <div>
              ...
              <p class="text-gray-400 text-sm mb-3">Schedule a call with us to discuss your project and get
                experienced and helpful guide based on your unique needs and experience.</p>
              <NuxtLink to="/contact"
          ...
          <div
            ...
            <div>
              ...
              <p class="text-gray-400 text-sm mb-3">Have questions or want to discuss your project in detail before
                committing? We can help you quickly whip up a prototype for a visual representation. Just call.
              </p>
              <NuxtLink to="/contact"
                class="text-purple-400 hover:text-purple-300 text-sm font-medium inline-flex items-center gap-1">
                Get Recommendation
          ...
          <div
            ...
            <div>
              ...
              <p class="text-gray-400 text-sm mb-3">HReady to move forward? Share your requirements and get a detailed
                proposal tailored to your specific needs.</p>
              <NuxtLink to="/contact"
                class="text-purple-400 hover:text-purple-300 text-sm font-medium inline-flex items-center gap-1">
                Contact Us
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24" fill="none"
