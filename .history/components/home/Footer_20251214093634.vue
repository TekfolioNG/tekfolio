        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div
            ...
            <div>
              ...
              <p class="text-gray-400 text-sm mb-3">
                Have an idea or early requirements? Schedule a focused call to review scope, options, and next steps.
              </p>
              <NuxtLink to="/contact"
          ...
          <div
            ...
            <div>
              ...
              <p class="text-gray-400 text-sm mb-3">
                Not sure where to start? We'll help you explore your options, answer your questions, and even create a
