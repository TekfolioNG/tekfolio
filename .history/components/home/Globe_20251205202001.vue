    ...
    <section class="relative w-full py-16 md:py-24 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="relative">
                ...
                <div
                    class="relative z-10 grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-3 px-4 md:px-8 lg:px-12 mb-4 md:mb-0">
                ...
                <div class="relative w-full h-[400px] md:h-[500px] lg:h-[600px] mt-4 lg:mt-0 overflow-hidden">
                    <div id="lottie-globe" class="w-full h-[200%]"
                        style="transform: translateY(0); transform-origin: top center;"></div>
                </div>
