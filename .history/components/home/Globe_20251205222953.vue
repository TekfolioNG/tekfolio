    ...
    <section class="relative w-full py-16 md:py-24 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="relative">
                ...
                <div
                    class="relative z-10 grid grid-cols-2 md:flex md:justify-center md:items-start gap-4 md:gap-6 lg:gap-8 px-4 md:px-8 lg:px-12 mb-[-70px] md:mb-[-90px] lg:mb-[-120px]">
