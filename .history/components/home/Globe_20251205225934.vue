<template>
    <section
        class="relative w-full py-16 md:py-24 min-h-[800px] md:min-h-[900px] lg:min-h-[1000px] bg-white overflow-hidden">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="relative mt-12 md:mt-16">
                <div
                    class="grid grid-cols-2 md:flex md:justify-center md:items-start gap-2 md:gap-1 lg:gap-2 px-4 md:px-8 lg:px-12">
...
/* Globe container - full size, behind content */
.lottie-wrapper {
    position: absolute;
    top: 50%;
    left: 50%;
