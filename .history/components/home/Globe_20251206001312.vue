    ...
    <section class="relative w-full py-16 md:py-24 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="relative mt-12">
                ...
                <div class="absolute top-0 left-1/2 w-full h-full pointer-events-none z-0">
                    <div ref="lottieContainer" class="lottie-wrapper"></div>
                </div>

                <!-- Stats Grid - Positioned Above Globe -->
                <div
                    class="relative z-10 grid grid-cols-2 md:flex md:justify-center md:items-start gap-4 md:gap-6 lg:gap-8 px-4 md:px-8 lg:px-12">
