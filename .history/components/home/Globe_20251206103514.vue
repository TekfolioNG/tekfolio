    ...
    <section class="relative w-full py-16 md:py-24 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="relative mt-12 min-h-[300px] md:min-h-[400px]">
                ...
                <div
                    class="relative z-10 grid grid-cols-2 md:flex md:justify-center md:items-start gap-4 md:gap-6 lg:gap-8 px-2 md:px-8 lg:px-12 py-4 md:py-8">
...
@media (max-width: 640px) {
    ...
    /* Moved globe higher and made it bigger */
    .globe-container {
