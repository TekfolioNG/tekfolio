        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="relative mt-6 min-h-[300px] md:min-h-[400px]">
                ...
                <div
                    ...
                    <!-- Divider 1 -->
                    <div class="hidden md:flex stat-divider-vertical divider-animated"
...
/* Divider animation - Desktop only with slide-up effect */
.divider-animated {
    opacity: 0;
}
...
.divider-animated.divider-visible .divider-dot {
    transform: translateY(0);
    opacity: 1;
}

/* Animated divider line with slide-up effect */
.divider-line {
    width: 2px;
    height: 100%;
    ...
    transition: transform 1.2s cubic-bezier(0.34, 1.56, 0.64, 1) 0.1s,
        opacity 1s ease-out 0.1s;
}

.divider-animated.divider-visible .divider-line {
    transform: translateY(0);
    opacity: 1;
}
