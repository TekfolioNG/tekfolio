<template>
    <section class="relative w-full md:-mb-40 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="relative mt-6 min-h-[300px] md:min-h-[400px]">
                ...
                <div
                    class="relative z-10 grid grid-cols-2 md:flex md:justify-center md:items-start -gap-3 md:-gap-3 lg:-gap-4 px-4 md:px-8 lg:px-12 py-4">
