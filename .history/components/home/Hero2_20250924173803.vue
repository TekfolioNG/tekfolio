<template>
    <main class="relative w-screen h-screen overflow-hidden">
        ...
        <div class="absolute inset-0 bg-[#fe4135] h-[85%] md:h-[98%]" style="top: 0;">
            <!-- Hero Content -->
                        ...
                        <div class="relative max-w-lg fade-in-card">
                            ...
                            <div
                                ...
                                <div class="space-y-4 card-content">
                                    <p class="text-lg md:text-xl lg:text-2xl leading-relaxed font-light text-gray-900">
...
/* Gray text slides in from right */
.slide-text-gray {
    color: #111827;
    /* gray-900 */
    opacity: 0;
...
/* White text slides in from left */
.slide-text-white {
    opacity: 0;
    transform: translateX(-50px);
    transition: all 0.8s cubic-bezier(0.4, 0, 0.2, 1);
