<template>
    <main class="relative w-screen h-screen overflow-hidden">
        ...
        <div class="absolute inset-0 bg-[#4669A9] h-full" style="top: 0;">
            <!-- Hero Content -->
                        ...
                        <div class="relative max-w-lg fade-in-card">
                            ...
                            <div
                                ...
                                <div class="flex items-center mb-4">
                                    <div class="w-8 h-0.5 bg-[#4669A9] mr-3"></div>
                                ...
                                <div class="mt-6">
                                    <NuxtLink to="/who-we-are"
                                        class="inline-flex items-center px-6 py-3 bg-[#4669A9] text-white font-semibold rounded-lg hover:bg-[#4669A9]/90 transform hover:scale-105 transition-all duration-300 group cta-button">
                                        Learn More
