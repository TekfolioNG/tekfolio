...
import engineeringImage from '~/assets/img/Syntanium Energy-home.jpg';
import maintenanceImage from '~/assets/img/Syntanium Energy-home4.jpg';
import constructionImage from '~/assets/img/Syntanium Energy-home5.jpg';
