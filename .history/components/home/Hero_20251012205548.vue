    ...
    <div class="absolute inset-0 z-10 flex items-center">
      <div class="container mx-auto px-4 md:px-8 lg:px-12">
        <div class="flex justify-center md:justify-start">
          <!-- Text Content Box -->
          <div class="text-center md:text-left max-w-xl bg-black/40 backdrop-blur-sm p-8 rounded-lg">
            <!-- Hero Heading -->
            <h1 class="text-white text-3xl md:text-4xl lg:text-5xl font-bold leading-snug mb-4">
