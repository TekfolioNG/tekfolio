<template>
  <main class="relative w-screen h-screen overflow-hidden">
    ...
    <!-- Content Container -->
    <div class="absolute inset-0 z-10 flex items-center pt-16 md:pt-0">
      <div class="container mx-auto px-4 md:px-8 lg:px-12">
        <div class="flex justify-center md:justify-start">
          <!-- Text Content Box -->
          <div class="text-center md:text-left max-w-xl bg-[#00D4FF]/20 backdrop-blur-sm p-8 rounded-lg">
            <!-- Hero Heading -->
