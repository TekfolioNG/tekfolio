<template>
  <main class="relative w-screen h-screen overflow-hidden">
    ...
    <!-- Content Container -->
    <div class="absolute inset-0 z-10 flex items-center md:items-end md:pb-16">
      <div class="container mx-auto px-4 md:px-8 lg:px-16">
        <div class="flex justify-center md:justify-start md:ml-0 lg:ml-8">
          <!-- Text Content Box -->
          <div class="text-center md:text-left max-w-xl p-6 md:p-0">
            <!-- Hero Heading -->
            <div class="bg-black/50 backdrop-blur-sm px-4 py-3 rounded-lg inline-block mb-4">
              <h1 class="text-white text-2xl md:text-3xl lg:text-4xl font-bold leading-tight">
            ...
            <!-- Description -->
            <div class="bg-black/50 backdrop-blur-sm px-4 py-3 rounded-lg mb-6">
