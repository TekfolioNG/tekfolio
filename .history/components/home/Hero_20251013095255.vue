          ...
          <div class="text-center md:text-left max-w-xl">
            ...
            <div class="h-10 mb-4 flex justify-center md:justify-start">
              <transition name="fade-service" mode="out-in">
                <p :key="currentService" 
                   class="text-[#00D4FF] text-xl md:text-2xl font-semibold"
                   style="text-shadow: 2px 2px 6px rgba(0, 0, 0, 0.9), 0 0 15px rgba(0, 0, 0, 0.6);">
            ...
            <p class="text-white text-sm md:text-base leading-relaxed mb-6"
               style="text-shadow: 1px 1px 6px rgba(0, 0, 0, 0.8), 0 0 15px rgba(0, 0, 0, 0.5);">
            ...
            <div class="flex justify-center md:justify-start">
              <NuxtLink to="/services"
                class="group inline-flex items-center gap-3 px-8 py-4 bg-[#00D4FF] hover:bg-[#00B8E6] text-gray-900 font-semibold text-lg rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl shadow-lg">
