          ...
          <div class="text-center md:text-left max-w-xl">
            ...
            <div class="h-10 mb-4 flex justify-center md:justify-start">
              <transition name="fade-service" mode="out-in">
                <p :key="currentService" class="text-[#B0E0E6] text-xl md:text-2xl font-semibold drop-shadow-md">
            ...
            <div class="flex justify-center md:justify-start">
              <NuxtLink to="/about-us"
                class="group inline-flex items-center gap-3 px-8 py-4 bg-[#B0E0E6] hover:bg-[#00B8E6] text-gray-900 font-semibold text-lg rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
                Learn More
                <!-- Chevron arrow -->
