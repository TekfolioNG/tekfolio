          ...
          <div class="text-center lg:text-left order-2 lg:order-1">
            ...
            <div class="flex flex-wrap justify-center lg:justify-start gap-3 md:gap-4 mb-6 text-white">
              <div class="text-center">
                ...
                <p class="text-xs md:text-sm text-gray-300">Book Projects</p>
              </div>
              <div class="text-center">
                <p class="text-xl md:text-2xl font-bold text-gold">70+</p>
                <p class="text-xs md:text-sm text-gray-300">Ghostwriting Achievements</p>
              </div>
              <div class="text-center">
                <p class="text-xl md:text-2xl font-bold text-gold">500+</p>
                <p class="text-xs md:text-sm text-gray-300">Clarity Sessions</p>
              </div>
            </div>
