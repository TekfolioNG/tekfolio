<template>
  <main class="relative w-screen h-screen overflow-hidden">
    ...
    <!-- Content Container -->
    <div class="absolute inset-0 z-10 flex items-center py-8 md:py-12 lg:py-16">
      <div class="container mx-auto px-4 md:px-8 lg:px-12 h-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center h-full">

          <!-- Left Side - Hero Text Content -->
          <div class="text-center lg:text-left order-2 lg:order-1 pt-4 lg:pt-0">
            <!-- Animated Headlines -->
            <div class="mb-4 md:mb-6 space-y-3 md:space-y-4">
              <transition name="fade-headline" appear>
                <h1 v-show="showFirstHeadline"
                  class="text-white text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight md:leading-tight drop-shadow-lg">
              ...
              <transition name="fade-headline" appear>
                <h2 v-show="showSecondHeadline"
                  class="text-gold text-lg md:text-xl lg:text-2xl xl:text-3xl font-semibold leading-tight md:leading-tight drop-shadow-md mt-2 md:mt-3">
            ...
            <!-- Description -->
            <p
              class="text-gray-100 text-sm md:text-base lg:text-lg leading-relaxed mb-6 md:mb-8 font-medium max-w-2xl mx-auto lg:mx-0 px-2 md:px-0">
            ...
            <!-- Stats -->
            <div class="flex flex-wrap justify-center lg:justify-start gap-4 md:gap-6 mb-6 md:mb-8 text-white">
          ...
          <div
            class="relative h-[250px] md:h-[350px] lg:h-[500px] order-1 lg:order-2 flex items-center justify-center py-4 lg:py-0">
