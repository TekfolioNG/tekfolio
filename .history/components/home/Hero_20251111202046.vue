<template>
  <main class="relative w-screen h-screen overflow-hidden">
    ...
    <!-- Content Container -->
    <div class="absolute inset-0 z-10 flex items-center pt-8 md:pt-20 pb-4 md:pb-8">
      <div class="container mx-auto px-4 md:px-8 lg:px-12 h-full max-h-screen overflow-y-auto">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center min-h-full py-4 md:py-0">
          ...
          <div class="text-center lg:text-left order-2 lg:order-1 space-y-3 md:space-y-4">
            <!-- Animated Headlines - Alternating -->
            <div
              class="space-y-1 md:space-y-2 min-h-[120px] sm:min-h-[140px] md:min-h-[160px] lg:min-h-[180px] xl:min-h-[200px] flex items-center justify-center lg:justify-start">
              <transition name="fade-headline" mode="out-in">
                <h1 v-if="showFirstHeadline" :key="'first'"
            ...
            <div class="hidden sm:flex flex-wrap justify-center lg:justify-start gap-2 md:gap-4 text-white py-2">
            ...
            <div class="flex flex-col sm:flex-row gap-2 md:gap-3 justify-center lg:justify-start pt-2">
              ...
              <NuxtLink to="/book-session"
                class="group inline-flex items-center justify-center gap-2 w-full sm:w-auto px-5 md:px-6 py-2.5 md:py-3 bg-brand-blue hover:bg-brand-blue-dark text-white font-bold text-sm md:text-base rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl">
              ...
              <NuxtLink to="/services"
                class="group inline-flex items-center justify-center gap-2 w-full sm:w-auto px-5 md:px-6 py-2.5 md:py-3 bg-transparent border-2 border-white hover:bg-white hover:text-gray-900 text-white font-semibold text-sm md:text-base rounded-lg transition-all duration-300">
          ...
          <div
            class="relative h-[280px] sm:h-[300px] md:h-[350px] lg:h-[500px] order-1 lg:order-2 flex items-center justify-center">
...
const showFirstHeadline = ref(true);
...
const rotateHeadlines = () => {
  headlineTimer = setInterval(() => {
    showFirstHeadline.value = !showFirstHeadline.value;
  }, 4000);
};
...
/* Headline fade-in/out animations */
