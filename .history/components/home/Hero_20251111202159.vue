          ...
          <div class="text-center lg:text-left order-2 lg:order-1 space-y-3 md:space-y-4">
            ...
            <div class="flex flex-col sm:flex-row gap-2 md:gap-3 justify-center lg:justify-start pt-2">
              ...
              <NuxtLink to="/book-session"
                class="group inline-flex items-center justify-center gap-2 w-full sm:w-auto px-4 md:px-6 py-3 md:py-3 bg-blue-brand hover:bg-blue-600 text-white font-bold text-sm md:text-base rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl">
