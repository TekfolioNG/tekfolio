        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center min-h-full py-4 md:py-0">
          ...
          <div class="text-center lg:text-left order-2 lg:order-1 space-y-3 md:space-y-4">
            ...
            <div class="space-y-1 md:space-y-2">
              ...
              <h3
                class="text-gold text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold leading-tight drop-shadow-lg">
...
// Rotate books every 4 seconds (1 second longer than before)
const rotateBooks = () => {
...
/* Book fade transition - extended duration to match longer display time */
