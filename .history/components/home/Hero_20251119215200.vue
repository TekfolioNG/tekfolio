...
// Rotate books every 3 seconds (faster transition)
const rotateBooks = () => {
...
/* Slide transition - faster and no fade */
...
/* Book display container - larger sizes */
...
/* Sharper and larger book cover images */
.book-cover-image {
