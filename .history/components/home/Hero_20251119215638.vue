        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center min-h-full py-4 md:py-0">
          ...
          <div
            ...
            <div class="book-display-container">
              <transition name="slide-book" mode="out-in">
                <img :key="currentBookIndex" :src="books[currentBookIndex]" :alt="`Book Cover ${currentBookIndex + 1}`"
...
// Rotate books every 3.5 seconds (slightly longer for smoother transition)
const rotateBooks = () => {
...
onMounted(() => {
  // Start book rotation after a brief delay
  setTimeout(() => {
    rotateBooks();
  }, 500);
});
