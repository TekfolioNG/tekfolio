      ...
      <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center w-full py-12 lg:py-0">
        ...
        <div class="text-center lg:text-left order-2 lg:order-1 lg:col-span-3 space-y-5 lg:pr-8 lg:pt-16">
          ...
          <div class="space-y-1">
            <h1 class="hero-headline leading-[1.1]">
              ...
              <span class="relative inline-block mt-1">
                ...
                <svg class="double-underline absolute -bottom-3 left-0 w-full" viewBox="0 0 300 20"
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
            ...
            <NuxtLink to="/contact"
              class="group relative inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-700 to-blue-600 text-white font-bold text-base lg:text-lg rounded-xl overflow-hidden transition-all duration-300 shadow-lg hover:shadow-purple-500/50 hover:scale-105">
            ...
            <NuxtLink to="/work"
              class="group relative inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-gray-900 font-semibold text-base lg:text-lg rounded-xl transition-all duration-300 button-gradient-border hover:scale-105">
              <span class="relative flex items-center gap-2 z-10">
                See Our Work
                <svg class="w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" fill="none"
                  stroke="currentColor" viewBox="0 0 24 24">
