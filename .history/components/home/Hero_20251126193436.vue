<template>
  <main class="relative w-full min-h-screen overflow-hidden bg-white">
    ...
    <div class="container mx-auto px-4 md:px-8 lg:px-12 min-h-screen flex items-center">
          ...
          <div class="space-y-1">
            <h1 class="hero-headline leading-[1.1]">
              ...
              <span class="relative inline-block mt-1">
                ...
                <!-- Double angled underline - Shorter and stylish (now 50% width) -->
                <svg class="double-underline absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-1/2"
      ...
      <div class="absolute bottom-24 left-1/2 transform -translate-x-1/2 w-full max-w-5xl px-4">
        <div class="bg-white rounded-xl shadow-2xl px-8 py-6">
          <div class="flex flex-col md:flex-row gap-8 items-center justify-center">
            ...
            <div class="hidden md:block w-px h-12 bg-gradient-to-b from-purple-700 to-blue-600"></div>
