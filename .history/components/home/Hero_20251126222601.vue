<template>
  <main class="relative w-full min-h-screen overflow-hidden bg-white">
    ...
    <div class="container mx-auto px-4 md:px-8 lg:px-12 min-h-screen flex items-center">
          ...
          <div class="space-y-1">
            <h1 class="hero-headline leading-[1.1]">
              ...
              <span class="relative inline-block mt-1">
                ...
                <!-- Double angled underline - Shorter and stylish (now 40% width, aligned left) -->
                <svg class="double-underline absolute -bottom-3 left-0 w-2/5" viewBox="0 0 300 20"
      ...
      <!-- Trust Indicators - Single Horizontal Card spanning both columns -->
      <div
        class="absolute bottom-8 sm:bottom-12 md:bottom-16 left-1/2 transform -translate-x-1/2 w-full max-w-6xl px-4 sm:px-6">
        <div class="bg-white rounded-xl shadow-2xl px-6 sm:px-8 md:px-10 py-6 sm:py-7 md:py-8">
          <div class="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-12 items-center justify-center">
            <!-- Indicator 1 -->
            <div class="flex items-start gap-4 flex-1 text-center md:text-left w-full md:w-auto">
              <img src="~/assets/img/security.png" alt="Security"
                class="w-10 h-10 sm:w-12 sm:h-12 flex-shrink-0 hidden md:block" />
              <div>
                <h3 class="text-gray-900 font-bold text-base sm:text-lg md:text-xl mb-2">Trusted by Businesses in
                  Nigeria and Beyond</h3>
                <p class="text-gray-600 text-sm sm:text-base">Reliable digital solutions built for real-world use and
                  long-term
                  performance.</p>
              </div>
            </div>
            ...
            <div class="hidden md:block w-px h-16 lg:h-20 bg-gradient-to-b from-purple-700 to-blue-600"></div>
            ...
            <div class="flex items-start gap-4 flex-1 text-center md:text-left w-full md:w-auto">
              <img src="~/assets/img/quality.png" alt="Quality"
                class="w-10 h-10 sm:w-12 sm:h-12 flex-shrink-0 hidden md:block" />
              <div>
                <h3 class="text-gray-900 font-bold text-base sm:text-lg md:text-xl mb-2">Quality, Delivered Fast</h3>
                <p class="text-gray-600 text-sm sm:text-base">Speed without compromise plus rapid development that ships
                  with
                  precision.</p>
              </div>
            </div>
