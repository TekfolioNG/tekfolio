  ...
  <main class="relative w-full min-h-screen overflow-hidden bg-white">
    ...
    <div class="container mx-auto px-4 md:px-8 lg:px-12 min-h-screen flex items-center">
      <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center w-full py-12 lg:py-0">
        ...
        <div
          class="text-center lg:text-left order-2 lg:order-1 lg:col-span-3 space-y-5 lg:pr-8 lg:pt-16 mb-32 sm:mb-36 md:mb-40">
          ...
          <div class="space-y-1">
            <h1 class="hero-headline leading-[1.1]">
              ...
              <span class="relative inline-block mt-1">
                ...
                <!-- Double angled underline - Shorter and stylish (now 40% width, centered) -->
                <svg class="double-underline absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-2/5"
      ...
      <!-- Trust Indicators - Single Horizontal Card at the bottom of the section -->
      <div class="w-full max-w-6xl mx-auto px-4 sm:px-6 mt-8 lg:mt-0">
        <div class="bg-white rounded-xl shadow-2xl px-6 sm:px-8 md:px-10 py-4 sm:py-5">
          <div class="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-12 items-center justify-center">
            ...
            <div class="flex items-start gap-4 flex-1 text-center md:text-left w-full md:w-auto">
              ...
              <div>
                <h3 class="text-gray-900 font-bold text-base sm:text-lg md:text-xl mb-1">Trusted by Businesses in
            ...
            <div class="hidden md:block w-px h-12 lg:h-14 bg-gradient-to-b from-purple-700 to-blue-600"></div>
            ...
            <div class="flex items-start gap-4 flex-1 text-center md:text-left w-full md:w-auto">
              <img src="~/assets/img/quality.png" alt="Quality"
                class="w-10 h-10 sm:w-12 sm:h-12 flex-shrink-0 hidden md:block" />
              <div>
                <h3 class="text-gray-900 font-bold text-base sm:text-lg md:text-xl mb-1">Quality, Delivered Fast</h3>
