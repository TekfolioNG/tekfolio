<template>
  <main class="relative w-full min-h-screen overflow-hidden bg-white">
    ...
    <div class="absolute -bottom-8 left-1/2 transform -translate-x-1/2 w-full max-w-6xl px-4 sm:px-6">
      <div class="bg-white rounded-xl shadow-xl px-6 sm:px-8 py-4 sm:py-5 border border-gray-100">
        <div class="flex flex-col md:flex-row gap-4 md:gap-8 lg:gap-12 items-center justify-center">
          ...
          <div class="flex items-start gap-3 flex-1 text-center md:text-left w-full md:w-auto">
            <img src="~/assets/img/security.png" alt="Security"
              class="w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0 hidden md:block filter-brand" />
            <div>
              <h3 class="text-gray-900 font-bold text-sm sm:text-base md:text-lg mb-1">Trusted by Businesses in Nigeria
                and Beyond</h3>
              <p class="text-gray-700 text-sm sm:text-base">Reliable digital solutions built for real-world use and
          ...
          <div class="flex items-start gap-3 flex-1 text-center md:text-left w-full md:w-auto">
            ...
            <div>
              ...
              <p class="text-gray-700 text-sm sm:text-base">Speed without compromise plus rapid development that ships
                with precision.</p>
            </div>
          </div>
        </div>
...
.filter-brand {
  filter: invert(25%) sepia(87%) saturate(2593%) hue-rotate(249deg) brightness(90%) contrast(90%);
}
