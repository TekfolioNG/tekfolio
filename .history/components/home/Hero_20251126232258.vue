<template>
  <main class="relative w-full min-h-screen overflow-hidden bg-white">
          ...
          <div class="space-y-1">
            <h1 class="hero-headline leading-[1.1]">
              ...
              <span class="relative inline-block mt-1">
                ...
                <!-- Double angled underline - Centered and shorter -->
    ...
    <div class="absolute -bottom-12 left-1/2 transform -translate-x-1/2 w-full max-w-6xl px-12 sm:px-6">
      <div class="bg-gray-100 rounded-xl shadow-lg px-6 sm:px-8 py-5 sm:py-6 border border-gray-400"
        style="box-shadow: 0 10px 30px -5px rgba(0, 0, 0, 0.15), 0 4px 6px -2px rgba(0, 0, 0, 0.05);">
        <div class="flex flex-col md:flex-row gap-4 md:gap-8 lg:gap-12 items-center justify-center">
          <!-- Indicator 1 -->
          <div class="flex items-start gap-3 flex-1 text-center md:text-left w-full md:w-auto">
            <img src="~/assets/img/security.png" alt="Security"
              class="w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0 hidden md:block brand-icon-filter" />
            <div>
              <h3 class="text-gray-900 font-bold text-sm sm:text-base md:text-lg mb-1">Trusted by Businesses in Nigeria
                and Beyond</h3>
              <p class="text-gray-900 text-sm sm:text-base">Reliable digital solutions built for real-world use and
          ...
          <div class="flex items-start gap-3 flex-1 text-center md:text-left w-full md:w-auto">
            <img src="~/assets/img/quality.png" alt="Quality"
              class="w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0 hidden md:block brand-icon-filter" />
            <div>
              <h3 class="text-gray-900 font-bold text-sm sm:text-base md:text-lg mb-1">Quality, Delivered Fast</h3>
              <p class="text-gray-900 text-sm sm:text-base">Speed without compromise plus rapid development that ships
                with precision.</p>
            </div>
          </div>
        </div>
