<template>
  <main class="relative w-full min-h-screen overflow-hidden bg-white pb-24 md:pb-16">
    <!-- Content Container -->
    ...
    <div class="absolute -bottom-12 md:bottom-2 left-1/2 transform -translate-x-1/2 w-full max-w-6xl px-4 sm:px-6">
          ...
          <div class="flex items-start gap-3 flex-1 text-center md:text-left w-full md:w-auto">
            ...
            <div>
              <h3 class="text-gray-900 font-bold text-sm sm:text-base md:text-lg mb-1">Trusted by Businesses in Nigeria
                and Beyond</h3>
              <p class="text-gray-900 text-xs sm:text-sm md:text-base">Reliable digital solutions built for real-world
                use and
