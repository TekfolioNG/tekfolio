<template>
  <main class="relative w-full min-h-screen overflow-hidden bg-white pb-24 md:pb-16">
    ...
    <div class="absolute -bottom-12 md:bottom-4 left-1/2 transform -translate-x-1/2 w-full max-w-6xl px-4 sm:px-6">
      <!-- Desktop: Single Card -->
      ...
      <div class="grid grid-cols-2 gap-3 md:hidden">
        ...
        <div class="bg-gray-100 rounded-xl shadow-lg px-4 py-4 border border-gray-100"
          ...
          <div class="flex flex-col items-center text-center gap-2">
            <img src="~/assets/img/security.png" alt="Security" class="w-10 h-10 brand-icon-filter" />
            <div>
              <h3 class="text-gray-900 font-bold text-xs mb-1">Trusted by Businesses</h3>
              <p class="text-gray-900 text-[10px] leading-tight">Reliable solutions built for long-term performance.</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-gray-100 rounded-xl shadow-lg px-4 py-4 border border-gray-100"
          style="box-shadow: 0 10px 30px -5px rgba(0, 0, 0, 0.55), 0 4px 6px -2px rgba(0, 0, 0, 0.35);">
          <div class="flex flex-col items-center text-center gap-2">
            <img src="~/assets/img/quality.png" alt="Quality" class="w-10 h-10 brand-icon-filter" />
            <div>
              <h3 class="text-gray-900 font-bold text-xs mb-1">Quality, Delivered Fast</h3>
              <p class="text-gray-900 text-[10px] leading-tight">Speed without compromise plus rapid development.</p>
            </div>
          </div>
        </div>
      </div>
