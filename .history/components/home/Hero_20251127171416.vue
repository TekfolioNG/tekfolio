          ...
          <div class="space-y-1">
            <h1 class="hero-headline leading-[1.1]">
              ...
              <span class="relative inline-block mt-1">
                ...
                <svg class="absolute -bottom-3 left-0 w-full h-4" viewBox="0 0 300 20" preserveAspectRatio="none">
                  <!-- Top line -->
                  <path d="M0,12 Q150,4 300,8" stroke="url(#underlineGradient1)" stroke-width="3" fill="none"
                    stroke-linecap="round" />
                  <!-- Bottom line -->
                  <path d="M0,16 Q150,8 300,12" stroke="url(#underlineGradient2)" stroke-width="3" fill="none"
                    stroke-linecap="round" />
                  <defs>
