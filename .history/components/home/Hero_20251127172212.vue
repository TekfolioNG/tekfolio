          ...
          <div class="space-y-1">
            <h1 class="hero-headline leading-[1.1]">
              ...
              <span class="relative inline-block mt-1">
                ...
                <svg class="absolute -bottom-2 left-0 w-full h-2 sm:h-3" viewBox="0 0 200 12"
                  preserveAspectRatio="none">
                  <path d="M2 7C50 4 100 2 198 6" stroke="url(#underlineGradient1)" stroke-width="2"
                    class="sm:stroke-[2.5]" stroke-linecap="round" fill="none" />
                  <path d="M2 10C50 7 100 5 198 9" stroke="url(#underlineGradient2)" stroke-width="2"
                    class="sm:stroke-[2.5]" stroke-linecap="round" fill="none" />
                  <defs>
