<template>
  <main class="relative w-full min-h-screen overflow-hidden pb-16 md:pb-16 transition-colors duration-300"
    :class="isDarkMode ? 'bg-gradient-to-br from-purple-900 to-blue-900' : 'bg-white'">
    <!-- Content Container -->
      ...
      <div class="grid grid-cols-1 lg:grid-cols-5 gap-4 md:gap-8 lg:gap-12 items-center w-full py-8 md:py-12 lg:py-0">
        ...
        <div class="text-center lg:text-left order-2 lg:order-1 lg:col-span-3 space-y-3 md:space-y-5 lg:pr-8 lg:pt-16">
          ...
          <div class="space-y-1">
            <h1 class="hero-headline leading-[1.1]">
              <span
                class="block text-3xl sm:text-3xl md:text-4xl lg:text-[2.75rem] font-bold transition-colors duration-300"
                :class="isDarkMode ? 'text-gray-100' : 'text-gray-900'">
                Your Tech Advantage.
              </span>
              <span class="relative inline-block mt-1">
                <span
                  class="text-3xl sm:text-3xl md:text-4xl lg:text-[2.75rem] font-bold transition-colors duration-300"
                  :class="isDarkMode ? 'text-gradient-dark' : 'text-gradient'">
                  Built Differently
                </span>
                ...
                <svg class="accent-circle absolute -inset-2 -z-10 w-[110%] sm:w-[105%] md:w-full" viewBox="0 0 200 80"
                  ...
                  <ellipse cx="100" cy="40" rx="98" ry="38" fill="none"
                    :stroke="isDarkMode ? 'url(#gradient-dark)' : 'url(#gradient)'" stroke-width="2" opacity="0.3" />
                  <defs>
                ...
                <svg class="absolute -bottom-2 left-1/2 -translate-x-1/2 w-[65%] sm:w-full h-3" viewBox="0 0 200 12"
                  ...
                  <path d="M2 7C50 4 100 2 198 6"
                    :stroke="isDarkMode ? 'url(#underlineGradient1-dark)' : 'url(#underlineGradient1)'"
                    stroke-width="2.5" stroke-linecap="round" fill="none" />
                  <path d="M2 10C50 7 100 5 198 9"
                    :stroke="isDarkMode ? 'url(#underlineGradient2-dark)' : 'url(#underlineGradient2)'"
                    stroke-width="2.5" stroke-linecap="round" fill="none" />
                  <defs>
                    ...
                    <linearGradient id="underlineGradient1-dark" x1="0%" y1="0%" x2="100%" y2="0%">
                      <stop offset="0%" style="stop-color:#C4B5FD;stop-opacity:1" />
                      <stop offset="100%" style="stop-color:#93C5FD;stop-opacity:1" />
                    </linearGradient>
                    <linearGradient id="underlineGradient2-dark" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <!-- Description -->
          <p class="text-sm md:text-base lg:text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0 font-medium transition-colors duration-300"
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2 md:pt-4">
            ...
            <NuxtLink to="/work"
              class="group relative inline-flex items-center justify-center gap-2 px-8 py-4 font-semibold text-base lg:text-lg rounded-xl button-gradient-border cta-button transition-colors duration-300"
              :class="isDarkMode ? 'bg-white/10 text-white' : 'bg-white text-gray-900'">
              <span class="relative flex items-center gap-2 z-10">
                See Our Work
                <svg class="w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" fill="none"
                  stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div
          ...
          <div id="lottie-animation"
            class="lottie-container w-full h-full flex items-center justify-center transition-all duration-300"
            :class="isDarkMode ? 'lottie-inverted' : ''">
    ...
    <div class="absolute bottom-2 md:bottom-4 left-1/2 transform -translate-x-1/2 w-full max-w-6xl px-4 sm:px-6">
      <!-- Desktop: Single Card -->
      <div class="hidden md:block rounded-xl shadow-lg px-6 sm:px-8 py-4 sm:py-5 border transition-colors duration-300"
        :class="isDarkMode ? 'bg-white/10 border-purple-700/30' : 'bg-gray-100 border-gray-100'"
        ...
        <div class="flex flex-row gap-8 lg:gap-12 items-center justify-center">
          ...
          <div class="flex items-start gap-3 flex-1 text-left">
            <img src="~/assets/home/img/security.png" alt="Security"
              class="w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0 transition-all duration-300"
              :class="isDarkMode ? 'brand-icon-filter-dark' : 'brand-icon-filter'" />
            <div>
              <h3 class="font-bold text-sm sm:text-base md:text-lg mb-1 transition-colors duration-300"
                :class="isDarkMode ? 'text-gray-100' : 'text-gray-900'">Trusted by Businesses in Nigeria
                and Beyond</h3>
              <p class="text-xs sm:text-sm md:text-base transition-colors duration-300"
                :class="isDarkMode ? 'text-gray-200' : 'text-gray-900'">Reliable digital solutions built for
          ...
          <div class="flex items-start gap-3 flex-1 text-left">
            ...
            <div>
              <h3 class="font-bold text-sm sm:text-base md:text-lg mb-1 transition-colors duration-300"
                :class="isDarkMode ? 'text-gray-100' : 'text-gray-900'">Quality, Delivered
                Fast</h3>
              <p class="text-xs sm:text-sm md:text-base transition-colors duration-300"
                :class="isDarkMode ? 'text-gray-200' : 'text-gray-900'">Speed without compromise plus rapid development.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="grid grid-cols-2 gap-3 md:hidden">
        <!-- Card 1 -->
        <div class="rounded-xl shadow-lg px-4 py-4 border transition-colors duration-300"
          :class="isDarkMode ? 'bg-white/10 border-purple-700/30' : 'bg-gray-100 border-gray-100'"
          style="box-shadow: 0 10px 30px -5px rgba(0, 0, 0, 0.55), 0 4px 6px -2px rgba(0, 0, 0, 0.35);">
          <div class="flex flex-col items-center text-center gap-2">
            <div>
              <h3 class="font-bold text-xs mb-1 transition-colors duration-300"
                :class="isDarkMode ? 'text-gray-100' : 'text-gray-900'">Trusted by Businesses in Nigeria</h3>
            </div>
          </div>
        </div>
        ...
        <div class="rounded-xl shadow-lg px-4 py-4 border transition-colors duration-300"
          ...
          <div class="flex flex-col items-center text-center gap-2">
            <div>
              <h3 class="font-bold text-xs mb-1 transition-colors duration-300"
                :class="isDarkMode ? 'text-gray-100' : 'text-gray-900'">Quality, Delivered Fast. No Compromise.</h3>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="absolute bottom-0 left-0 right-0 h-32 pointer-events-none transition-colors duration-300"
      :class="isDarkMode ? 'bg-gradient-to-t from-blue-950/50 to-transparent' : 'bg-gradient-to-t from-gray-50/50 to-transparent'">
    </div>
  </main>
</template>
...
/* Light purple gradient for dark mode */
.text-gradient-dark {
...
.lottie-inverted {
  filter: invert(1) hue-rotate(180deg) drop-shadow(0 10px 40px rgba(196, 181, 253, 0.15));
}
...
/* Light/white filter for icons in dark mode */
