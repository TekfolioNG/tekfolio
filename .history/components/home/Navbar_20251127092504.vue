    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
      <div class="flex justify-between items-center h-18 lg:h-24">
        ...
        <div class="flex-shrink-0 flex items-center">
          <NuxtLink to="/"
            class="inline-block rounded-lg px-3 py-2 shadow-md hover:shadow-lg transition-shadow duration-200">
            <img src="/assets/home/img/tekfolio.png" alt="LiteraForge Logo" class="h-10 md:h-12 lg:h-16" />
          </NuxtLink>
        </div>
