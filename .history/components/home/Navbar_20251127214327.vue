      ...
      <div class="flex justify-between items-center h-16 lg:h-20">
        ...
        <div class="flex-shrink-0 flex items-center">
          <NuxtLink to="/" class="inline-block rounded-lg px-2 py-1 hover:opacity-80 transition-opacity duration-200">
            <img :src="isDarkMode ? '/assets/home/img/tekfolio-full2.png' : '/assets/home/img/tekfolio-full.png'"
              alt="Tekfolio Logo" class="h-8 md:h-8 lg:h-12 transition-opacity duration-300" />
          </NuxtLink>
        </div>
