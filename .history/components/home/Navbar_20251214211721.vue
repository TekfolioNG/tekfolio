              ...
              <div v-if="companyDropdownOpen"
                ...
                <div class="py-2">
                  <NuxtLink to="/about-us"
                    class="flex items-center gap-3 px-4 py-2.5 text-sm font-semibold transition-all duration-200"
    ...
    <Transition name="slide">
      <div v-if="mobileMenuOpen"
        ...
        <div class="px-4 py-6 space-y-2">
          ...
          <!-- Mobile Company Section with Dropdown -->
          <div class="space-y-1">
            ...
            <Transition name="mobile-dropdown">
              <div v-if="mobileCompanyOpen" class="pl-4 space-y-1">
                <NuxtLink to="/about-us"
                  class="flex items-center gap-3 font-semibold px-4 py-2.5 rounded-lg text-sm transition-all"
                  :class="route.path === '/about-us'
                    ? 'text-white bg-gradient-to-r from-purple-700 to-blue-600'
                    : isDarkMode
                      ? 'text-gray-100 hover:text-white hover:bg-white/10'
