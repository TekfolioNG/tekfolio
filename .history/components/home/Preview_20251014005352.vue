        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-10 text-center" ref="headerRef">
                ...
                <h2
                    ...
                    WE HELP TRANSFOR POTENTIAL INTO PERFORMANCE
                </h2>

                <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                    Our team focusses on ensuring small and growing businesses are able to scale, strengthen systems,
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="max-w-xl" ref="contentRef">
