        ...
        <div class="container mx-auto px-4 md:px-8 lg:px-12 relative z-10">
            ...
            <div class="text-center max-w-4xl mx-auto mb-16 md:mb-20">
                ...
                <p class="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto">
                    At Litera-Forge, we bridge strategy and creativity, enabling businesses, leaders, and authors to
                    transform ideas into lasting impact through structured execution and creative excellence.
                </p>
            </div>
