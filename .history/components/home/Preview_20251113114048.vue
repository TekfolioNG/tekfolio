    ...
    <section class="py-16 md:py-24 bg-gradient-to-br from-white to-blue-50/30 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 md:px-8 lg:px-12 relative z-10">
            ...
            <div class="text-center max-w-4xl mx-auto mb-16 md:mb-20">
                ...
                <h2 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 max-w-7xl mx-auto">
                ...
                <NuxtLink to="#"
                    class="group relative bg-white rounded-2xl p-8 transition-all duration-500 hover:transform hover:scale-[1.02] border border-blue-100/50 hover:border-[#4D7EFF]/20 hover:shadow-2xl hover:shadow-blue-500/10 shadow-lg shadow-gray-200/50">
                    <div
                    ...
                    <div class="relative z-10">
                        ...
                        <div
                            class="flex items-center text-[#4D7EFF] font-semibold mt-6 opacity-0 group-hover:opacity-100 transform translate-x-0 group-hover:translate-x-2 transition-all duration-500 justify-center md:justify-start">
