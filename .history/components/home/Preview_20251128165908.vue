<template>
    <main class="relative w-full min-h-screen overflow-hidden bg-white">
        ...
        <section class="bg-white py-12 md:py-12">
            <div class="container mx-auto px-4 md:px-8 lg:px-12">
                <div class="max-w-4xl mx-auto text-center">
                    <!-- Header -->
                    <h2 class="text-gray-900 text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight mb-2">
                        We build smart, simple and secure e-solutions
                    </h2>
