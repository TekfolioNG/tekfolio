<template>
    <section class="w-full bg-white py-4 md:py-8">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 items-center mb-2 md:mb-4">
                <!-- Text Content -->
                <div class="order-1 space-y-2 px-2">
                    <h2
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center mb-2 md:mb-4">
                ...
                <!-- Text Content -->
                <div class="order-1 lg:order-2 space-y-2 px-2">
                    <h2
                        class="text-gray-900 text-2xl md:text-3xl lg:text-4xl font-bold leading-tight text-center lg:text-left">
