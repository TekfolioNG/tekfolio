    ...
    <section class="w-full bg-white py-2 md:py-4">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center mb-2 md:mb-3">
                <!-- Text Content -->
                <div class="order-1 space-y-1 px-2 lg:pr-8">
                    <h2
                        class="text-gray-900 text-2xl md:text-3xl lg:text-4xl font-normal leading-tight text-center lg:text-left">
                ...
                <!-- Lottie Animation -->
                <div class="order-2 relative h-[250px] md:h-[350px] lg:h-[400px]">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center mb-2 md:mb-3">
                <!-- Lottie Animation -->
                <div class="order-2 lg:order-1 relative h-[250px] md:h-[350px] lg:h-[400px]">
                    <div id="lottie-mobile-apps" class="w-full h-full"></div>
                </div>

                <!-- Text Content -->
                <div class="order-1 lg:order-2 space-y-1 px-2 lg:pl-8">
                    <h2
