    ...
    <section class="w-full bg-white py-2 md:py-4">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center mb-2 md:mb-3">
                <!-- Text Content -->
                <div class="order-2 space-y-1 px-2 lg:pr-8">
                    <h2
                ...
                <!-- Lottie Animation -->
                <div class="order-1 relative h-[250px] md:h-[350px] lg:h-[400px]">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center mb-2 md:mb-3">
                ...
                <!-- Text Content -->
                <div class="order-2 lg:order-2 space-y-1 px-2 lg:pl-8">
                    <h2
                        class="text-gray-900 text-2xl md:text-3xl lg:text-4xl font-medium leading-tight text-center lg:text-left">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center">
                ...
                <!-- Text Content -->
                <div class="order-2 lg:order-2 space-y-1 px-2 lg:pl-8 mt-14 md:mt-0">
                    <h2
                        class="text-gray-900 text-2xl md:text-3xl lg:text-4xl font-medium leading-tight text-center lg:text-left">
