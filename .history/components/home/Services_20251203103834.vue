<template>
    <section class="w-full bg-white py-2 md:py-4">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <!-- Service 3: Creative Coding & Interactive Experiences (Text Left, Video Right) -->
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center mb-2 md:mb-3">
                <!-- Text Content -->
                <div class="order-2 lg:order-1 space-y-1 px-2 lg:pr-8">
                    <p class="text-gray-600 text-sm md:text-base font-medium italic text-center lg:text-left">
                        When your idea needs something unexpected—something with presence.
                    </p>
                    <h2
                        class="text-gray-900 text-2xl md:text-3xl lg:text-4xl font-medium leading-tight text-center lg:text-left">
                    ...
                    <p
                        class="text-gray-700 text-sm md:text-base lg:text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0 font-medium text-center lg:text-left">
                        We design expressive, interactive experiences that elevate brand stories, product launches, and data presentations. Clear. Engaging. Memorable. Built with the precision of engineering and the spirit of creative exploration.
                    </p>
                ...
                <div class="order-1 lg:order-2 relative h-[250px] md:h-[350px] lg:h-[400px]">
                    <video 
                        ref="creativeSampleVideo"
                        class="w-full h-full object-contain rounded-lg shadow-lg"
                        controls
                        preload="metadata"
                    >
                        <source src="https://pub-b093fb1bbec143f2bf250c4cd137a160.r2.dev/creative-sample-with-audio.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </div>
            </div>

            <!-- Service 4: Cloud Migration & Security (Animation Left, Text Right) -->
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center mb-2 md:mb-3">
                <!-- Lottie Animation -->
                <div class="order-1 lg:order-1 relative h-[250px] md:h-[350px] lg:h-[400px]">
            ...
            <!-- Service 5: SEO & Performance (Text Left, Animation Right) -->
