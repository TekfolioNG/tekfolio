    ...
    <section class="w-full bg-white py-2 md:py-4">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center mb-2 md:mb-3">
                ...
                <!-- Lottie Animation -->
                <div class="order-1 lg:order-2 relative h-[350px] md:h-[350px] lg:h-[400px]">
                    <div id="lottie-seo-performance" class="w-full h-full mb-4 md:mb-6"></div>
                </div>
            </div>
            ...
            <div
                ...
                <!-- Video Container -->
                <div class="order-1 lg:order-1 relative h-[250px] md:h-[300px] lg:h-[350px]">
                    <div class="relative w-full h-full rounded-lg overflow-hidden shadow-lg bg-gray-100">
                        <video ref="creativeSampleVideo" class="w-full h-full object-cover" preload="metadata"
                            poster="/sketch-sample.png" playsinline>
                            <source
                        ...
                        <div v-if="!isVideoPlaying" @click="playVideo"
                            class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 cursor-pointer hover:bg-opacity-40 transition-all duration-300 group">
                            <div
                                class="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-full bg-white bg-opacity-90 flex items-center justify-center shadow-2xl group-hover:scale-110 group-hover:bg-opacity-100 transition-all duration-300">
                                <svg class="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 text-purple-700 ml-1"
