    ...
    <section class="w-full bg-white py-2 md:py-4">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div
                ...
                <!-- Video Container -->
                <div class="order-1 lg:order-1 relative h-[220px] md:h-[280px] lg:h-[320px]">
                    <div class="relative w-full h-full rounded-lg overflow-hidden shadow-lg bg-gray-100">
                        <!-- Cover Image (shown before video plays) -->
                        <img v-if="!isVideoPlaying" src="/sketch-sample.png" alt="Creative Coding Sample Preview"
                        ...
                        <div v-if="!isVideoPlaying" @click="playVideo"
                            class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-20 cursor-pointer hover:bg-opacity-30 transition-all duration-300 group">
                            <div
