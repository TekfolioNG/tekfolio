    ...
    <section class="w-full bg-white py-2 md:py-4">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div
                ...
                <!-- Video Container - Made slightly smaller -->
                <div class="order-1 lg:order-1 relative h-[320px] md:h-[280px] lg:h-[320px]">
                    <div class="relative w-full h-full rounded-lg overflow-hidden shadow-lg bg-gray-100">

                        <!-- Cover Image - Always visible as background -->
                        ...
                        <video ref="creativeSampleVideo" class="absolute inset-0 w-full h-full object-cover"
                            preload="metadata" playsinline @play="isVideoPlaying = true" @pause="isVideoPlaying = false"
                        ...
                        <div v-if="!isVideoPlaying" @click="playVideo"
                            class="absolute inset-0 flex items-center justify-center bg-black/20 cursor-pointer hover:bg-black/30 transition-all duration-300 group">
                            <div
                                class="w-14 h-14 md:w-16 md:h-16 lg:w-18 lg:h-18 rounded-full bg-white/95 flex items-center justify-center shadow-2xl group-hover:scale-110 group-hover:bg-white transition-all duration-300">
                                <svg class="w-7 h-7 md:w-8 md:h-8 lg:w-9 lg:h-9 text-purple-700 ml-1"
                        ...
                        <!-- Custom Pause Button - Shows when video is playing -->
                        <div v-if="isVideoPlaying" @click="pauseVideo"
                            class="absolute inset-0 flex items-center justify-center cursor-pointer opacity-0 hover:opacity-100 transition-opacity duration-300 bg-black/20">
                            <div
                                class="w-14 h-14 md:w-16 md:h-16 lg:w-18 lg:h-18 rounded-full bg-white/95 flex items-center justify-center shadow-2xl">
                                <svg class="w-7 h-7 md:w-8 md:h-8 lg:w-9 lg:h-9 text-purple-700" fill="currentColor"
                                    viewBox="0 0 24 24">
                ...
                <div class="order-2 space-y-3 px-2 lg:pl-8">
                    ...
                    <p class="text-purple-700 text-sm md:text-base font-semibold text-center lg:text-left pt-1">
