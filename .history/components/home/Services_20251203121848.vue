            ...
            <div
                ...
                <div class="order-1 lg:order-1 relative h-[320px] md:h-[280px] lg:h-[320px]">
                    <div class="relative w-full h-full rounded-lg overflow-hidden shadow-lg">
                        ...
                        <!-- Cover Image - Slightly reduced on desktop to show full image -->
                        ...
                        <div v-if="isVideoPlaying" @click="pauseVideo"
                            class="absolute inset-0 flex items-center justify-center cursor-pointer opacity-0 hover:opacity-100 transition-opacity duration-300">
                            <div
