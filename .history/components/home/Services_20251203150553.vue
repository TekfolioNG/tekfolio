        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="order-1 lg:order-1 space-y-2">
                    ...
                    <!-- Video Container -->
                    <div class="relative h-[320px] md:h-[280px] lg:h-[420px]">
                        <div class="relative w-full h-full rounded-lg overflow-hidden shadow-lg">
                            ...
                            <div v-if="!isVideoPlaying" @click="playVideo"
                                ...
                                <div
                                    class="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-full bg-white/95 flex items-center justify-center shadow-2xl group-hover:scale-110 group-hover:bg-white transition-all duration-300">
                                    <!-- Lucide Play Icon -->
