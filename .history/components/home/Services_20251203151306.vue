    ...
    <section class="w-full bg-white py-2 md:py-4">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div
                ...
                <!-- Text Content -->
                <div class="order-2 lg:order-1 space-y-3 px-2 lg:pr-8">
                ...
                <!-- Video Container - Increased height on desktop only -->
                <div class="order-1 lg:order-2 relative">
                    <!-- Play prompt directly above the video container -->
                    <div class="mb-3">
                        <p class="text-purple-700 text-sm md:text-base font-semibold text-center">
                            ▶ Play the sample to experience what's possible.
                        </p>
                    </div>

                    <div class="relative h-[320px] md:h-[280px] lg:h-[380px] rounded-lg overflow-hidden shadow-lg">

                        <!-- Cover Image - Fixed to show full image without cutting -->
                        ...
                        <div v-if="!isVideoPlaying" @click="playVideo"
                            ...
                            <div
                                class="w-16 h-16 md:w-18 md:h-18 lg:w-20 lg:h-20 rounded-full bg-white/95 flex items-center justify-center shadow-2xl group-hover:scale-110 group-hover:bg-white transition-all duration-300">
                                <!-- Lucide Play Icon (slightly larger) -->
                                <svg class="w-8 h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 text-purple-700 ml-1" fill="none"
                        ...
                        <div v-if="isVideoPlaying" @click="pauseVideo"
                            class="absolute inset-0 flex items-center justify-center cursor-pointer bg-black/10 hover:bg-black/20 transition-all duration-300">
                            <div
                                class="w-16 h-16 md:w-18 md:h-18 lg:w-20 lg:h-20 rounded-full bg-white/95 flex items-center justify-center shadow-2xl">
                                <!-- Lucide Pause Icon -->
                                <svg class="w-8 h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 text-purple-700" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" viewBox="0 0 24 24">
