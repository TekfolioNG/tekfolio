        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div
                    ...
                    <div class="relative h-[320px] md:h-[280px] lg:h-[450px]">
                        <div class="relative w-full h-full rounded-lg overflow-hidden shadow-lg">
                            ...
                            <div v-if="!isVideoPlaying" @click="playVideo"
                                ...
                                <div
                                    class="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-full bg-purple-900/95 flex items-center justify-center shadow-2xl group-hover:scale-110 group-hover:bg-white transition-all duration-300">
                                    <!-- Lucide Play Icon -->
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-8 h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 text-white" viewBox="0 0 24 24"
                            ...
                            <div v-if="isVideoPlaying" @click="pauseVideo"
                                ...
                                <div
                                    class="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-full bg-white/95 flex items-center justify-center shadow-2xl">
                                    <!-- Lucide Pause Icon -->
                                    <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="order-2 space-y-3 px-2 lg:pl-8">
                    ...
                    <p class="text-purple-700 text-sm md:text-base font-semibold text-center lg:text-left">
