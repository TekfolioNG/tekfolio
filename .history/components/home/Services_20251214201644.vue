    ...
    <section class="w-full bg-white py-2 md:py-4">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center mb-2 md:mb-3">
                ...
                <!-- Lottie Animation -->
                <div class="order-1 lg:order-2 relative h-[240px] md:h-[300px] lg:h-[350px]">
                    ...
                    <div class="relative h-[320px] md:h-[280px] lg:h-[450px]">
                        <div class="relative w-full h-full rounded-lg overflow-hidden shadow-lg">
                            ...
                            <img src="/sketch-sample.png" alt="Creative Coding Sample Preview"
                                class="absolute inset-0 w-full h-[240px] md:h-[300px] lg:h-[350px] object-contain lg:scale-90"
                                :class="{ 'opacity-0': isVideoPlaying }">

                            <!-- Video Element -->
                            <video ref="creativeSampleVideo"
                                class="absolute inset-0 w-full h-[240px] md:h-[300px] lg:h-[350px] object-cover"
