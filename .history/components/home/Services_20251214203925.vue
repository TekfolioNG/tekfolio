        ...
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div
                ...
                <div class="order-1 lg:order-1 space-y-2">
                    ...
                    <!-- Video Container -->
                    <div class="relative w-full h-[170px] md:h-[220px] lg:h-[280px] max-w-3xl mx-auto">
                        <div class="relative w-full h-full rounded-lg overflow-hidden shadow-lg">
                            ...
                            <img src="/sketch-sample.png" alt="Creative Coding Sample Preview"
                                class="absolute inset-0 w-full h-[170px] md:h-[220px] lg:h-[280px]"
                                :class="{ 'opacity-0': isVideoPlaying }">

                            <!-- Video Element -->
                            <video ref="creativeSampleVideo"
                                class="absolute inset-0 w-full h-[170px] md:h-[220px] lg:h-[280px]" preload="metadata"
                                playsinline>
                                <source
