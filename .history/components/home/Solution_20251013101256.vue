            ...
            <div class="grid grid-cols-1 md:grid-cols-5">
                ...
                <div class="flex flex-col items-center text-center">
                    <NuxtLink to="/products-applications" class="group block">
                        ...
                        <h3
                            class="text-sm md:text-base font-barlow-extrabold text-gray-700 dark:text-gray-300 uppercase leading-tight group-hover:text-[#00D4FF] transition-colors duration-300">
