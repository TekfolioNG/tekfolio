    ...
    <section class="py-16 md:py-24 bg-white transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Consulting Card -->
                <div
                    class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-[#0099CC]/20 p-6 group">
                    <NuxtLink to="#" class="block">
                        <div class="flex flex-col items-center text-center mb-4">
                            <div class="mb-4 hover-bob">
                                <img src="/assets/img/consulting-elevation.png" alt="Consulting"
                                    ...
                                    style="filter: brightness(0) saturate(100%) invert(45%) sepia(98%) saturate(1523%) hue-rotate(161deg) brightness(95%) contrast(101%);" />
                            </div>
                            <h3
                                class="text-lg md:text-xl font-barlow-extrabold text-gray-900 uppercase leading-tight group-hover:text-[#0099CC] transition-colors duration-300 mb-3">
                                CONSULTING
                            </h3>
                        </div>
                        ...
                        <div class="flex justify-center">
                            <span
                                class="inline-flex items-center text-[#0099CC] font-semibold text-sm group-hover:translate-x-1 transition-transform duration-300">
                                Learn More
