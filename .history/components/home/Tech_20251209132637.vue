<template>
    <section class="relative w-full py-8 md:py-16 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">

            <div class="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">

                <!-- Left Side - Text Content -->
                <div class="text-center lg:text-left space-y-6 order-1 lg:col-span-2">
                ...
                <div class="relative h-[400px] md:h-[450px] lg:h-[500px] order-2 lg:col-span-3">
                    <div class="floating-container">
                        ...
                        <!-- Row 4 (optional 13th logo if needed) -->
...
/* Individual logo positions and animations - 4 per row layout */
...
/* Row 4 - Optional 13th logo centered */
.logo-13 {
    bottom: 5%;
    left: 18%;
    animation: floatTiltLeft 8.6s ease-in-out infinite 1.3s;
}
