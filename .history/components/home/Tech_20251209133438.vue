    ...
    <section class="relative w-full py-8 md:py-16 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
                ...
                <div class="text-center lg:text-left space-y-12 order-1 lg:col-span-2">
                ...
                <div class="relative h-[400px] md:h-[450px] lg:h-[500px] order-2 lg:col-span-3 px-4 lg:px-8">
