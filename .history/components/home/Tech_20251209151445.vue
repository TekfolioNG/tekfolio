                ...
                <div class="relative h-[400px] md:h-[350px] lg:h-[400px] order-2 lg:col-span-3 -mt-8 md:mt-0 lg:mt-0 ">
                    <div class="floating-container">
                        ...
                        <div class="logo-float logo-4">
                            <img src="/assets/img/css.png" alt="CSS" class="tech-logo" />
                        </div>
                        ...
                        <div class="logo-float logo-12">
                            <img src="/assets/img/github.png" alt="GitHub" class="tech-logo" />
                        </div>
...
@media (max-width: 768px) {
    ...
    /* Show row 4 logos on mobile */
    .logo-13 {
        display: flex;
        top: 30%;
        left: 8%;
        animation: floatTiltRight 8.6s ease-in-out infinite 0.4s;
    }
    ...
    .logo-14 {
        ...
        left: 50%;
        transform: translateX(-50%);
        animation: floatTiltLeft 9.4s ease-in-out infinite 0.9s;
    }
    ...
    .logo-15 {
        ...
        top: 30%;
        right: 8%;
        animation: floatTiltRight 8.3s ease-in-out infinite 1.4s;
    }
}
