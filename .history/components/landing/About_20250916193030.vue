                ...
                <div class="relative" ref="visualRef">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-12 transform transition-all duration-1000 hover:rotate-0 hover:shadow-3xl"
                            ...
                            <div class="space-y-6">
                                <div
                                    class="h-24 bg-gradient-to-r from-red-500/20 to-gray-900/20 dark:from-red-500/30 dark:to-white/30 rounded-xl">
                                </div>
                                <div class="space-y-3">
                                    <div class="h-3 bg-gray-200 dark:bg-gray-600 rounded"></div>
                                    <div class="h-3 bg-gray-200 dark:bg-gray-600 rounded w-4/5"></div>
                                    <div class="h-3 bg-gray-200 dark:bg-gray-600 rounded w-3/5"></div>
                                </div>
                            </div>
