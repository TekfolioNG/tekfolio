            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative" ref="visualRef">
                    ...
                    <div class="mb-12">
                        ...
                        <div class="w-16 h-0.5 bg-red-500 mb-6 transform transition-all duration-700"
                        ...
                        <div class="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-10 transform transition-all duration-1000 hover:rotate-0 hover:shadow-3xl"
                            ...
                            <div class="space-y-6 relative z-10">
                                <p
                                    ...
                                    Syntanium was founded on the belief that complex energy challenges demand simple,
                                    effective, and dependable solutions. From engineering design to construction and
                                    facility maintenance, we bring together technical skill and field experience to
                                    support projects that power industries and communities.
                                </p>

                                <p
                                    class="text-base md:text-lg leading-relaxed text-gray-700 dark:text-gray-300 font-light">
                                    Over the years, our team has grown into a trusted partner for operators seeking
                                    efficiency without compromise. Whether developing new infrastructure, upgrading
                                    existing assets, or ensuring facilities remain safe and productive, we work with a
