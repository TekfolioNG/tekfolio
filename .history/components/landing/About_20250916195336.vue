<template>
    <section class="py-20 px-6 bg-white dark:bg-gray-900 overflow-hidden">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-16 lg:mb-12" ref="headerRef">
                <div class="lg:text-left text-center">
                    <!-- Small accent line above heading -->
                    <div class="w-16 h-0.5 bg-red-500 lg:mx-0 mx-auto mb-6 transform transition-all duration-700"
                        :class="{ 'w-24': isVisible }"></div>

                    <!-- Main heading with Barlow font -->
                    <h2
                        class="text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-barlow font-extrabold text-gray-900 dark:text-white mb-6 tracking-tight">
                        OUR COMPANY
                    </h2>

                    <!-- Decorative elements -->
                    <div class="flex items-center lg:justify-start justify-center mb-8">
                        ...
                        <div class="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-10 transform transition-all duration-1000 hover:rotate-0 hover:shadow-3xl"
                            ...
                            <div class="mb-8">
                                <div class="flex items-center mb-4">
                                    ...
                                    <h3
                                        class="text-xl md:text-2xl font-barlow font-bold text-gray-900 dark:text-white uppercase tracking-wide">
                                        Our Story
                                    </h3>
                                </div>
                            </div>
