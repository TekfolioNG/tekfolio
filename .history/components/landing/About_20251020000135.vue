                ...
                <div class="order-1 lg:order-2">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-800 font-bold">Identify and overcome growth barriers</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-[#0077AA] mr-3 flex-shrink-0 mt-0.5" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-gray-800 bold">Develop tailored strategies for sustainable growth</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-[#0077AA] mr-3 flex-shrink-0 mt-0.5" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-gray-800 font-bold"> Integrate ESG principles into business operations
                            </span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-[#0077AA] mr-3 flex-shrink-0 mt-0.5" fill="none"
                            ...
                            <span class="text-gray-800 font-bold">Drive impact and outcomes through data-driven
                                decision-making.
                            </span>
                        </li>
                    </ul>
