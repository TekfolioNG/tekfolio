<template>
    <section class="relative -mt-8">
        ...
        <div class="hero-image relative w-full h-[300px] md:h-[450px] lg:h-[600px] overflow-hidden -mt-1">
        ...
        <!-- Content Section -->
        <section class="py-8 md:py-16 px-4 md:px-6 bg-white dark:bg-gray-900 -mt-1">
            <div class="max-w-7xl mx-auto">
                <!-- Desktop: Two Column Layout -->
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                    <!-- Left Column - Text Content -->
                    <div class="order-2 lg:order-1 px-2 md:pl-4 lg:pl-8 md:pr-8 lg:pr-12">
                        <h2
                    ...
                    <!-- Right Column - Image -->
                    <div class="order-1 lg:order-2 px-4 md:px-0">
                        <div class="relative">
                            ...
                            <div
                                class="relative bg-white dark:bg-gray-800 shadow-xl overflow-hidden mt-0 lg:-mt-16 mr-0 lg:-mr-8">
...
@media (max-width: 768px) {
    ...
    /* Ensure no top margin/gap on mobile images */
    .hero-image {
        margin-top: 0;
    }
...
/* Mobile-first approach for seamless layout */
