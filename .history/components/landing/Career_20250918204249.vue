<template>
    <section class="relative -mt-8">
        ...
        <div class="hero-image relative w-full h-[300px] md:h-[450px] lg:h-[600px] overflow-hidden -mt-8">
                ...
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                    ...
                    <div class="order-1 lg:order-2 px-4 md:px-0">
                        <div class="relative">
                            ...
                            <div
                                class="relative bg-white dark:bg-gray-800 shadow-xl overflow-hidden -mt-8 lg:-mt-16 mr-0 lg:-mr-8">
