<template>
    <section class="relative -mt-8">
        ...
        <!-- Content Section -->
        <section class="py-8 md:py-16 px-4 md:px-6 bg-white dark:bg-gray-900 mobile-content-gap">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                    ...
                    <!-- Right Column - Image -->
                    <div class="order-1 lg:order-2 mobile-full-width md:px-0">
                        <div class="relative">
                            ...
                            <div
                                class="relative bg-white dark:bg-gray-800 shadow-xl overflow-hidden mobile-image-container lg:-mt-16 mr-0 lg:-mr-8">
...
/* Mobile-specific fixes for gaps and full width */
@media (max-width: 768px) {

    /* Remove ALL top gaps on hero image */
    .mobile-no-gap {
        margin-top: 0 !important;
    }

    /* Remove gap between hero and content section */
    .mobile-content-gap {
        margin-top: 0 !important;
    }
    ...
    /* Remove negative margin on content image for mobile */
