    ...
    <section class="relative -mt-8">
        ...
        <section class="py-8 md:py-16 px-4 md:px-6 bg-white dark:bg-gray-900 mobile-no-gap">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex justify-center mb-12 md:mb-16">
                    <div class="relative">
                        ...
                        <div class="relative mb-2 md:mb-3">
                            <div
                                class="bg-gradient-to-r from-[#fe4135] via-red-500 to-red-600 rounded-lg px-8 md:px-12 py-3 md:py-4 shadow-xl transform rotate-2 hover:rotate-1 transition-transform duration-300">
                                <h2
                        ...
                        <!-- Second Box - "With Us?" -->
                        <div class="relative ml-16 md:ml-24">
                            <div
                                class="bg-gradient-to-r from-gray-800 via-gray-900 to-black rounded-lg px-8 md:px-12 py-3 md:py-4 shadow-xl transform -rotate-1 hover:rotate-0 transition-transform duration-300">
                                <h2
                                    class="text-xl md:text-2xl lg:text-3xl font-barlow font-bold text-white text-center leading-tight">
                                    With Us?
                                </h2>
                ...
                <!-- Two Column Layout -->
                <div class="grid lg:grid-cols-2 gap-2 lg:gap-4 items-center">
