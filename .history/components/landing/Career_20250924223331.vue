            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex justify-center mb-10 md:mb-12">
                    <div class="relative">
                        ...
                        <!-- Second Box - "With Us?" -->
                        <div class="relative ml-20 md:ml-28">
                            <div
                ...
                <!-- Two Column Layout -->
                <div class="grid lg:grid-cols-2 gap-0 lg:gap-1 items-center">
                    <!-- Left Column - Text Content -->
                    <div class="order-2 lg:order-1 px-2 md:pl-6 lg:pl-8 md:pr-6 lg:pr-8">
                        ...
                        <!-- Accent Elements -->
                        <div class="mt-4 md:mt-6 flex items-center justify-center lg:justify-start">
