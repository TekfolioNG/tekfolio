        ...
        <section class="py-8 md:py-16 px-4 md:px-16 bg-white dark:bg-gray-900 mobile-no-gap">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex justify-center mb-12 md:mb-16">
                    <div class="relative">
                        <!-- First Box - "Why Work" - Reduced padding and width -->
                        <div class="relative mb-2 md:mb-3">
                            <div
                                class="bg-gradient-to-r from-[#fe4135] via-red-500 to-red-600 rounded-lg px-6 md:px-8 py-3 md:py-4 shadow-xl transform rotate-2 hover:rotate-1 transition-transform duration-300">
                                <h2
                                    class="-pl-8 md:-pl-8 text-xl md:text-2xl lg:text-3xl font-barlow font-bold text-white text-center leading-tight">
                                    Why Work
                                </h2>
                            </div>
                        </div>
