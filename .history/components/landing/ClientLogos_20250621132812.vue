            ...
            <div class="relative overflow-hidden">
                ...
                <div class="flex space-x-8 animate-scroll" :class="{ 'paused': isHovered }"
                    ...
                    <NuxtLink v-for="(logo, index) in logos" :key="`first-${index}`" to="#" class="flex-shrink-0 group">
                        <div
                            class="w-32 h-20 flex items-center justify-center bg-white dark:bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300 group-hover:scale-105 border border-gray-200 dark:border-gray-300">
                            <img :src="logo.src" :alt="logo.alt"
                                class="max-w-full max-h-full object-contain transition-all duration-300 opacity-70 group-hover:opacity-100"
                                loading="lazy" />
                        </div>
                    </NuxtLink>
...
const logos = ref([
    ...
    { src: '/img/client-logo8.png', alt: 'Client Logo 8' },
