    ...
    <section class="py-16 bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-sm text-[#01348F] dark:text-gray-400 mt-6 font-medium">
...
const logos = ref([
    { src: '/img/client-logo1.png', alt: 'Client Logo 1', link: '#' },
    { src: '/img/client-logo2.png', alt: 'Client Logo 2', link: '#' },
    { src: '/img/client-logo3.png', alt: 'Client Logo 3', link: '#' },
    { src: '/img/client-logo4.png', alt: 'Client Logo 4', link: '#' },
    { src: '/img/client-logo5.png', alt: 'Client Logo 5', link: '#' },
    { src: '/img/client-logo6.png', alt: 'Client Logo 6', link: '#' },
    { src: '/img/client-logo7.png', alt: 'Client Logo 7', link: '#' },
    { src: '/img/client-logo9.png', alt: 'Client Logo 9', link: '#' },
    { src: '/img/client-logo10.png', alt: 'Client Logo 10', link: '#' },
    { src: '/img/client-logo11.png', alt: 'Client Logo 11', link: '#' },
    { src: '/img/client-logo12.png', alt: 'Client Logo 12', link: '#' }
])
