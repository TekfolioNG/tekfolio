    ...
    <section class="py-16 bg-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative overflow-hidden">
                <!-- Gradient Overlays -->
                <div
                    class="absolute left-0 top-0 w-5 h-full bg-gradient-to-r from-gray-100/90 to-transparent pointer-events-none">
                </div>
                <div
                    class="absolute right-0 top-0 w-5 h-full bg-gradient-to-l from-gray-100/90 to-transparent pointer-events-none">
                </div>
