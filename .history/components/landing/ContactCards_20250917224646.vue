...
/* Consolidated contact card styles */
.contact-card {
    @apply bg-gray-50 dark:bg-gray-800 rounded-xl p-8 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-2;
}

.contact-icon {
    @apply w-16 h-16 bg-red-500 rounded-xl mx-auto mb-6 flex items-center justify-center transform transition-transform duration-300 group-hover:scale-110;
}

.contact-title {
    @apply text-xl font-barlow font-bold text-gray-900 dark:text-white mb-4;
}
...
.contact-link {
    @apply text-gray-700 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400 transition-colors duration-300;
}
</style>