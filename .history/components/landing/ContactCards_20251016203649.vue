        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16">
                ...
                <div class="contact-card group">
                    ...
                    <div class="space-y-1">
                        <a href="mailto:info@elevationconsulting.com.ng" class="contact-link block text-base">
                            info@elevationconsulting.com.ng
                        </a>
                        <a href="mailto:elevationconsultingsg@gmail.com" class="contact-link block text-base">
