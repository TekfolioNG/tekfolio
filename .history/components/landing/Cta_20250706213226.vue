        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="text-center lg:text-left">
            ...
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-6 leading-tight">
              ...
              <span class="text-green-700">Bountiful Future—Together</span>
            </h2>

            <!-- Description -->
            <p class="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed">
              From restoring farmlands to reducing carbon and replacing firewood, our work touches lives and landscapes.
              Whether you're a farmer, partner, donor, or advocate—we invite you to join us in creating lasting change.
            </p>
