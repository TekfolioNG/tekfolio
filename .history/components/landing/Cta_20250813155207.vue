      ...
      <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div class="flex justify-center lg:justify-end">
          <div class="w-full max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl">
            <div class="relative">
              <div
                class="absolute inset-0 bg-gradient-to-r from-blue-400/30 to-blue-600/30 rounded-3xl transform rotate-6">
              </div>
              <div class="relative bg-white/80 rounded-3xl -p-8 shadow-2xl">
