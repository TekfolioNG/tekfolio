        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3">
                    ...
                    <div class="mb-8">
                        <div
                            ...
                            <div class="skew-x-[15deg]">
                                <Icon name="lucide:hard-hat" class="w-10 h-10 md:w-12 md:h-12 text-white" />
                            </div>
                        </div>
                ...
                <div class="flex flex-col items-center text-center p-8 md:p-10 relative">
                    <div class="mb-8">
                        <div
                            class="w-16 h-24 md:w-20 md:h-28 bg-[#fe4135] skew-x-[-15deg] flex items-center justify-center mx-auto mb-6">
                            <div class="skew-x-[15deg]">
                                <Icon name="lucide:building" class="w-10 h-10 md:w-12 md:h-12 text-white" />
                            </div>
                        </div>
                        <h3 class="text-xl md:text-xl font-barlow-extrabold text-[#fe4135] dark:text-white mb-4">
                            CONSTRUCTION
                        </h3>
                ...
                <div class="flex flex-col items-center text-center p-8 md:p-10">
                    <div class="mb-8">
                        <div
                            class="w-16 h-24 md:w-20 md:h-28 bg-[#fe4135] dark:bg-red-900/30 skew-x-[-15deg] flex items-center justify-center mx-auto mb-6">
                            <div class="skew-x-[15deg]">
                                <Icon name="lucide:settings" class="w-10 h-10 md:w-12 md:h-12 text-white" />
                            </div>
                        </div>
                        <h3 class="text-xl md:text-xl font-barlow-extrabold text-[#fe4135] mb-4">
                            MAINTENANCE
