                    ...
                    <div class="mb-8">
                        <div
                            ...
                            <div class="skew-x-[15deg]">
                                <img src="~/assets/img/engineering.png" alt="Engineering"
                                    class="w-30 h-30 md:w-36 md:h-36 object-contain filter brightness-0 invert" />
                            </div>
                        </div>
                ...
                <div class="flex flex-col items-center text-center p-8 md:p-10">
                    <div class="mb-8">
                        <div
                            class="w-16 h-24 md:w-20 md:h-28 bg-[#fe4135] skew-x-[-15deg] flex items-center justify-center mx-auto mb-6">
                            <div class="skew-x-[15deg]">
                                <img src="~/assets/img/maintenace.png" alt="Maintenance"
                                    class="w-12 h-18 md:w-12 md:h-16 object-contain filter brightness-0 invert" />
                            </div>
                        </div>
                        <h3 class="text-xl md:text-xl font-barlow-extrabold text-[#fe4135] mb-4">
                            MAINTENANCE
