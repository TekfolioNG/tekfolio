            ...
            <div class="grid grid-cols-1 md:grid-cols-3">
                ...
                <div class="flex flex-col items-center text-center p-8 md:p-10 relative">
                    <div class="mb-8">
                        ...
                        <p class="text-gray-800 dark:text-gray-300 leading-relaxed font-barlow-thin">
                    ...
                    <!-- Vertical separator -->
                    <div
                        class="hidden md:block absolute top-1/2 right-0 w-px h-1/2 bg-gray-500 dark:bg-gray-700 transform -translate-y-1/2">
                    </div>
                </div>
