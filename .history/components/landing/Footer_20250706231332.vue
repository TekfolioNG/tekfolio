<template>
  <footer class="bg-[#1a3a0a] text-white pt-16 pb-8 px-6 sm:px-8">
    <div class="container mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
        ...
        <div class="md:col-span-4 flex flex-col items-center md:items-start">
          <NuxtLink to="/">
            <img src="~/assets/img/veraverde-logo-footer.png" alt="Vera Verde Logo" class="h-20 md:h-24" />
          </NuxtLink>
          ...
          <NuxtLink to="/about"
            class="text-[#a0d468] hover:text-white transition-colors text-sm inline-flex items-center">
            Learn more about us
        ...
        <div class="md:col-span-2 flex flex-col items-center md:items-start">
          <h3 class="text-lg font-semibold mb-6 text-[#a0d468]">
            Quick Links
          </h3>
          ...
          <ul class="space-y-4 text-center md:text-left">
            <li class="flex flex-col md:flex-row items-center md:items-start">
              <div class="flex items-start mb-2 md:mb-0 md:mr-3">
                <Icon name="heroicons:map-pin" class="h-5 w-5 text-[#a0d468] flex-shrink-0 mt-1" />
              </div>
            ...
            <li class="flex flex-col md:flex-row items-center md:items-start">
              <div class="flex items-center mb-2 md:mb-0 md:mr-3">
                <Icon name="heroicons:phone" class="h-5 w-5 text-[#a0d468] flex-shrink-0" />
              </div>
              <div class="text-gray-300 text-sm">
            ...
            <li class="flex flex-col md:flex-row items-center md:items-start">
              <div class="flex items-center mb-2 md:mb-0 md:mr-3">
                <Icon name="heroicons:envelope" class="h-5 w-5 text-[#a0d468] flex-shrink-0" />
              </div>
              <div class="text-gray-300 text-sm">
            ...
            <li class="flex flex-col md:flex-row items-center md:items-start">
              <div class="flex items-center mb-2 md:mb-0 md:mr-3">
                <Icon name="mdi:whatsapp" class="h-5 w-5 text-[#a0d468] flex-shrink-0" />
              </div>
              <div class="text-gray-300 text-sm">
      ...
      <!-- Footer Bottom -->
      <div class="border-t border-[#2a4a1a] pt-6">
