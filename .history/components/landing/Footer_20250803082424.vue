          ...
          <ul class="space-y-4 text-center md:text-left">
            ...
            <li class="flex flex-col md:flex-row items-center md:items-start">
              <div class="flex items-center mb-2 md:mb-0 md:mr-3">
                <Icon name="heroicons:phone" class="h-5 w-5 text-[#D2691E] flex-shrink-0" />
              </div>
              <div class="text-gray-300 text-sm">
            ...
            <li class="flex flex-col md:flex-row items-center md:items-start">
              <div class="flex items-center mb-2 md:mb-0 md:mr-3">
                <Icon name="heroicons:envelope" class="h-5 w-5 text-[#D2691E] flex-shrink-0" />
              </div>
              <div class="text-gray-300 text-sm">
            ...
            <li class="flex flex-col md:flex-row items-center md:items-start">
              <div class="flex items-center mb-2 md:mb-0 md:mr-3">
                <Icon name="mdi:whatsapp" class="h-5 w-5 text-[#D2691E] flex-shrink-0" />
              </div>
              <div class="text-gray-300 text-sm">
                <strong class="block text-white mb-1">WhatsApp:</strong>
                <a href="https://wa.me/2348034272579" class="hover:text-[#D2691E] transition-colors">
                  Chat with us
                </a>
              </div>
            </li>
          ...
          <div class="order-1 md:order-2 flex flex-col md:flex-row items-center gap-4">
            ...
            <div class="flex gap-3">
              <a href="#" target="_blank" rel="noopener noreferrer"
                class="text-gray-400 hover:text-[#D2691E] transition-colors" aria-label="Facebook">
                <Icon name="mdi:facebook" size="20" />
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer"
                class="text-gray-400 hover:text-[#D2691E] transition-colors" aria-label="Twitter">
                <Icon name="mdi:twitter" size="20" />
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer"
                class="text-gray-400 hover:text-[#D2691E] transition-colors" aria-label="Instagram">
                <Icon name="mdi:instagram" size="20" />
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer"
                class="text-gray-400 hover:text-[#D2691E] transition-colors" aria-label="LinkedIn">
