    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        ...
        <div class="col-span-1 md:col-span-2 lg:col-span-1">
          <div class="mb-6">
            <NuxtLink to="/" class="inline-block">
              <img src="/assets/img/bot-logo.png" alt="Syntanium Energy Logo" class="h-16 md:h-20 lg:h-24 drop-shadow-lg" />
            </NuxtLink>
          </div>
          <p class="text-gray-300 mb-6 max-w-md">
            Syntanium Energy delivers innovative engineering, construction, and maintenance solutions for the energy sector with uncompromising commitment to safety and quality.
          </p>
          <div class="flex space-x-4">
            <a href="#" class="text-gray-400 hover:text-[#fe4135] transition-colors duration-200">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li>
              <a href="#" class="text-gray-300 hover:text-[#fe4135] transition-colors duration-200 flex items-center">
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li class="flex items-start">
              ...
              <span class="text-gray-300">123 Energy Avenue, Industrial District, City, Country</span>
            </li>
      ...
      <div class="border-t border-gray-700 pt-8 mb-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex w-full md:w-auto">
            ...
            >
            <button class="bg-[#fe4135] hover:bg-[#dc2626] px-4 py-2 rounded-r-lg text-white font-medium transition-colors duration-200">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div class="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="flex space-x-6">
          <a href="#" class="text-gray-400 hover:text-[#fe4135] text-sm transition-colors duration-200">Privacy Policy</a>
          <a href="#" class="text-gray-400 hover:text-[#fe4135] text-sm transition-colors duration-200">Terms of Service</a>
          <a href="#" class="text-gray-400 hover:text-[#fe4135] text-sm transition-colors duration-200">Cookie Policy</a>
        </div>
      </div>
    </div>
  </footer>
