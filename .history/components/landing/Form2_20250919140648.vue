    ...
    <section class="py-20 px-6 bg-gray-900">
        <div class="max-w-5xl mx-auto">
            ...
            <form ref="form" @submit.prevent="submitForm"
                class="bg-gray-800 rounded-2xl shadow-xl p-8 md:p-10 border border-gray-700">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="fullName" name="fullName" v-model="formData.fullName" required
                                class="w-full px-4 py-3 bg-gray-900 border border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent text-white transition-colors duration-300 shadow-sm"
                ...
                <div class="mb-8">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <!-- Position Type -->
                        <div>
                            <label for="positionType" class="block text-sm font-medium text-gray-300 mb-2">
                                Application Type *
                            </label>
                        ...
                        <div v-if="formData.positionType === 'specific'">
                            <label for="specificPosition" class="block text-sm font-medium text-gray-300 mb-2">
                                Position Category *
                            </label>
                        ...
                        <div v-if="formData.positionType === 'spontaneous'">
                            <label for="preferredDepartment" class="block text-sm font-medium text-gray-300 mb-2">
                        ...
                        <!-- Experience Level -->
                        <div>
                            <label for="experienceLevel" class="block text-sm font-medium text-gray-300 mb-2">
                                Experience Level *
                            </label>
                ...
                <div class="mb-8">
                    ...
                    <!-- Education -->
                    <div class="mb-6">
                        <label for="education" class="block text-sm font-medium text-gray-300 mb-2">
                    ...
                    <!-- Key Skills -->
                    <div class="mb-6">
                        <label for="keySkills" class="block text-sm font-medium text-gray-300 mb-2">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="file" id="resume" name="resume" @change="handleFileUpload" required
                                accept=".pdf,.doc,.docx"
                                class="w-full px-4 py-3 bg-gray-900 border border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent text-white transition-colors duration-300 shadow-sm file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:bg-red-500 file:text-white hover:file:bg-red-600">
                            <p class="text-xs text-gray-400 mt-1">Accepted formats: PDF, DOC, DOCX (Max 5MB)</p>
                        </div>

                        <!-- Cover Letter Upload -->
                        <div>
                            <label for="coverLetter" class="block text-sm font-medium text-gray-300 mb-2">
                ...
                <div class="mb-8">
                    ...
                    <!-- Why Syntanium -->
                    <div class="mb-6">
                        <label for="whySyntanium" class="block text-sm font-medium text-gray-300 mb-2">
                    ...
                    <!-- Additional Comments -->
                    <div class="mb-6">
                        <label for="additionalInfo" class="block text-sm font-medium text-gray-300 mb-2">
                            Additional Comments
                        </label>
                    ...
                    <!-- LinkedIn Profile -->
                    <div class="mb-6">
                        <label for="linkedinProfile" class="block text-sm font-medium text-gray-300 mb-2">
                ...
                <div class="mb-8">
                    <div class="flex items-start">
                        <input type="checkbox" id="privacy" name="privacy" v-model="formData.privacyConsent" required
                            class="mt-1 mr-3 h-4 w-4 text-red-500 focus:ring-red-500 border-gray-600 bg-gray-900 rounded">
                        <label for="privacy" class="text-sm text-gray-300 leading-relaxed">
                ...
                <div class="text-center">
                    <button type="submit" :disabled="isSubmitting"
                        class="px-8 py-4 bg-red-500 hover:bg-red-600 text-white font-semibold rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 focus:ring-offset-gray-800 disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg">
...
const submitForm = async () => {
    ...
    try {
        ...
        if (result.success) {
            ...
            submitMessageClass.value = 'bg-green-900/30 text-green-300 border border-green-500/30'
        ...
        submitMessageClass.value = 'bg-red-900/30 text-red-300 border border-red-500/30'
    } finally {
