        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                    Have questions about our services or ready to start a project? Reach out to our team.
                </p>
            </div>

            <!-- Contact Form -->
            <form ref="form" @submit.prevent="submitForm" class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8">
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" v-model="formData.name" required
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent dark:bg-gray-800 dark:text-white transition-colors duration-300"
                ...
                <div class="text-center">
                    <button type="submit" :disabled="isSubmitting"
                        class="px-8 py-4 bg-red-500 hover:bg-red-600 text-white font-barlow font-semibold rounded-lg transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed">
