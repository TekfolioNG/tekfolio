        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-10 lg:mb-12">
                ...
                <p class="text-lg text-gray-900 max-w-2xl mx-auto">
                    A clarity session helps you gain fresh perspective, identify next steps, and receive expert guidance
                    on your project or business concern. <br class="hidden md:block">We make the experience simple,
                    insightful, and supportive—helping you and your team move forward with confidence.
