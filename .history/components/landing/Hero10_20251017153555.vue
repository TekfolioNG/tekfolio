            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <div class="max-w-4xl mx-auto">
                        <h2
                            class="font-barlow-extrabold text-2xl md:text-3xl lg:text-4xl text-gray-900 leading-tight text-center mb-4">
                            We're Helping to Empower Enterprises to Grow, Compete, and Succeed
                        </h2>
                        <p
                        ...
                        <p class="text-lg sm:text-xl text-gray-700 leading-relaxed text-center">
                            ...
                            entrepreneurs, corporations, and development institutions strengthen systems, unlock growth,
