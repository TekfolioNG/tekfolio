<template>
    <div class="min-h-screen bg-white">
            ...
            <div class="relative z-10 h-full flex items-center justify-end">
                <div class="container mx-auto px-6 md:px-12">
                    <div class="max-w-lg ml-auto">
                        ...
                        <div class="relative bg-gradient-to-br from-white/95 to-gray-50/95 backdrop-blur-sm p-6 md:p-10 shadow-2xl"
                            style="clip-path: polygon(0 0, 100% 0, 100% 85%, 95% 100%, 0 100%);">
                            <h1 class="text-3xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-3">
                                About Us
                            </h1>
                            <p class="text-base md:text-xl text-[#4D7EFF] font-semibold italic">
                                Clarity, Structure, and Meaningful Impact
                            </p>
                            <div class="mt-4 md:mt-6 w-16 md:w-20 h-1 bg-gradient-to-r from-[#4D7EFF] to-blue-300">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="w-full bg-gradient-to-br from-white via-blue-50/30 to-white py-16 lg:py-24 mt-8 md:mt-0">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div class="order-1 lg:order-1">
                        ...
                        <div class="mb-8 text-center lg:text-left">
                            <div class="inline-flex items-center gap-3 mb-4 justify-center lg:justify-start">
                        ...
                        <!-- Content -->
                        <div class="space-y-6 text-gray-700 text-center lg:text-left">
                    ...
                    <div class="order-2 lg:order-2">
                        <div class="relative group">
                            <!-- Vertical Image Container with Reduced Height -->
                            <div
                                class="aspect-[4/5] max-w-md mx-auto lg:max-w-full rounded-2xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500">
