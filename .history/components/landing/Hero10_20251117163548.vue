                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div class="order-2 lg:order-2">
                        <div class="relative group">
                            ...
                            <div
                                class="aspect-[3/4] h-[400px] lg:h-[800px] max-w-md mx-auto lg:max-w-full rounded-2xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500">
