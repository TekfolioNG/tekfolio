            ...
            <div class="relative z-10 h-full flex items-center justify-end">
                <div class="container mx-auto px-6 md:px-12">
                    <div class="max-w-md ml-auto">
                        ...
                        <div class="relative bg-gradient-to-br from-white/80 to-gray-50/75 backdrop-blur-sm p-5 md:p-8 shadow-2xl"
                            style="clip-path: polygon(0 0, 100% 0, 100% 85%, 95% 100%, 0 100%);">
                            <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-3">
                                About Us
                            </h1>
                            <p class="text-base md:text-lg text-[#4D7EFF] font-semibold italic">
                                Clarity, Structure, and Meaningful Impact
                            </p>
                            <div class="mt-5 w-16 h-1 bg-gradient-to-r from-[#4D7EFF] to-blue-300"></div>
                        </div>
                    </div>
                </div>
            </div>
