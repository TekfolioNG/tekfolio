    ...
    <div class="min-h-screen bg-white">
        ...
        <section class="relative w-full h-96 md:h-[500px] overflow-hidden">
            ...
            <div class="absolute inset-0">
                <img :src="publishingImage" alt="  Employee Productivity Training"
                ...
                <div class="mb-8">
                    <div class="max-w-4xl mx-auto">
                        <p
                            ...
                            We turn your manuscript into a polished, market-ready book<br><i><strong>—without the
                                    overwhelm.</strong></i></br>


                        </p>
                        <p class="text-lg sm:text-xl text-gray-700 leading-relaxed text-center mb-4">
                            At Litera-Forge, we provide complete publishing support for authors who want a professional,
                            structured, and stress-free process. Whether you’re refining an early draft or preparing a
                            final manuscript for release, we guide you through every stage with clarity and expertise.
                        </p>
...
<script setup>
import publishingImage from '~/assets/img/publishing-literaforge.png';
</script>
