<template>
    <section
        ...
        <div class="hidden md:flex h-full items-center">
            ...
            <div class="flex-1 flex items-center justify-center px-8 lg:px-16">
                <div class="max-w-lg text-center lg:text-left">
                    ...
                    <div class="w-20 h-1 bg-[#00D4FF] mx-auto lg:mx-0 mb-6"></div>
        ...
        <div class="md:hidden h-full relative">
            ...
            <div class="relative z-10 h-full flex items-center justify-center px-6">
                <div class="text-center">
                    ...
                    <div class="w-20 h-1 bg-[#00D4FF]0 mx-auto mb-4"></div>
                    <p class="text-lg text-gray-200 leading-relaxed max-w-sm mx-auto">
                        Ready to grow your business? Reach out and let’s build something impactful together.
                    </p>
                </div>
            </div>
        </div>
        ...
        <!-- Decorative elements -->
        <div class="absolute top-8 right-8 w-2 h-2 bg-{#00D4FF} rounded-full opacity-60"></div>
        <div class="absolute bottom-8 left-8 w-1.5 h-1.5 bg-[#00D4FF] rounded-full opacity-40"></div>

        <!-- Subtle geometric shapes for visual interest -->
        <div class="absolute top-1/4 right-1/4 w-32 h-32 border border-[#00D4FF]-500/10 rounded-full hidden lg:block">
        </div>
