<template>
    <div class="min-h-screen bg-white">
        ...
        <section class="relative w-full h-96 md:h-[500px] overflow-hidden bg-gray-900/95">
            ...
            <div class="absolute inset-0 md:inset-y-0 md:-left-20 md:right-auto md:w-[120%] lg:w-[140%]">
                <ClientOnly>
                    <DotLottieVue autoplay loop
                        src="https://lottie.host/41709ac1-f3f7-4dbc-85ca-f84e09ac13e4/fASMzFhLnZ.lottie"
                        class="w-full h-full object-cover" :style="{ objectFit: 'cover' }" />
                </ClientOnly>
            </div>
            ...
            <div class="relative z-10 h-full flex items-center justify-end">
                <div class="container mx-auto px-6 md:px-12">
                    <div class="max-w-[280px] md:max-w-md ml-auto">
...
/* Fix Lottie aspect ratio on mobile */
:deep(svg) {
