            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <div class="max-w-4xl mx-auto">
                        <p class="text-lg sm:text-xl md:text-3xl text-gray-800 leading-relaxed text-center mb-4">
...
<script setup>
import aboutUsImage from '~/assets/img/programs-events-elevation.jpg';
</script>
