            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center">
                    <p class="text-lg sm:text-xl lg:text-2xl text-white leading-relaxed lg:leading-loose font-light">
                        Syntanium supports oil and gas operations with solutions that prioritize
                        safety, efficiency, and sustainability. We bring technical
                        expertise, local insight, and global standards to every stage of the energy lifecycle.
                    </p>
                </div>
            </div>
        </section>
