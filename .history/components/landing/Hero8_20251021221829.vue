                ...
                <div class="mb-8">
                    <div class="max-w-4xl mx-auto">
                        <p
                            ...
                            Tranforming Vision to Scalable Growth
                        </p>
                        <p class="text-lg sm:text-xl text-gray-700 leading-relaxed text-center mb-4">
                            We help entrepreneurs and organizations move from concept to reality, assisting with
                            building structures, systems, and strategies that support sustainable growth. Our approach
                            blends practical insight with hands-on execution, ensuring every idea becomes an
                            investment-ready enterprise.
...
<script setup>
import aboutUsImage from '~/assets/img/biz-dev-elevation2.jpg';
</script>
