...
.btn-primary {
  @apply bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300;
}

.btn-secondary {
  @apply bg-transparent hover:bg-white hover:text-blue-700 text-white font-bold py-3 px-6 rounded-lg border-2 border-white transition-colors duration-300;
}
</style>