  ...
  <main class="relative w-screen h-screen overflow-hidden">
    ...
    <div class="container mx-auto pl-8 md:pl-16 lg:pl-20 pr-4 h-full flex items-center pt-16 relative z-10">
      <div class="max-w-3xl text-white ml-4 md:ml-8">
        ...
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-semibold mb-6 flex flex-wrap items-center">
          <div class="flex flex-wrap md:flex-nowrap items-center">
            <span ref="wordSwitcher"
              class="word-switcher text-blue-300 font-black inline-block min-w-[160px] mr-2"></span>
            <span class="lowercase font-medium heading-text">business</span>
          </div>
          <span class="lowercase font-medium heading-text w-full md:w-auto">solutions that work</span>
        </h1>
...
onMounted(() => {
  ...
  const rotateWords = () => {
    gsap.to(wordSwitcher.value, {
      ...
      onComplete: () => {
        ...
        // Fade in new word with enhanced effects
        gsap.to(wordSwitcher.value, {
          duration: 0.8,
          opacity: 1,
          scale: 1,
  ...
  // Initial entrance animation with enhanced effects
  ...
  setInterval(rotateWords, 5000); // 5 seconds per word
});
</script>
...
/* Enhanced word switcher styling */
.word-switcher {
  font-weight: 900;
...
/* Button styles with improved hover effects that work on mobile */
.btn-primary {
...
@media (max-width: 768px) {
  ...
  /* Dynamic layout adjustments for heading text */
  .heading-text {
    font-size: 1em;
  }
  ...
  /* Fix for touch devices to ensure hover effects work */
  @media (hover: none) {
    .btn-primary:active {
      background-color: #1d4ed8;
      transform: translateY(-2px);
