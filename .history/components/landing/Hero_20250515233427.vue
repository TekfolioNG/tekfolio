...
.btn-primary {
  ...
  text-align: center;
  -webkit-tap-highlight-color: rgba(29, 78, 216, 0.5);
}
...
.button-touch-effect.btn-primary {
  background-color: #1d4ed8;
}

.button-touch-effect.btn-secondary {
  background-color: white;
  color: #1d4ed8;
}
...
/* Ensure button hover effects work on all devices */
.btn-primary:active,
.btn-secondary:active {
  transform: translateY(-2px);
}
