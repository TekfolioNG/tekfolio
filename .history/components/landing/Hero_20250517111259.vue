    ...
    <div class="container mx-auto pl-8 md:pl-16 lg:pl-20 pr-4 h-full flex items-center pt-16 relative z-10">
      <div class="max-w-3xl text-white ml-4 md:ml-8">
        ...
        <p class="text-lg md:text-xl mt-6 mb-10 leading-relaxed text-white">
          Achieve more with scalable, next-gen websites and apps. <br>Our versed and innovative team </br>of tech geeks helps
          breathe life <br>into your vision and </br>maximize your business's potential with modern, user-optimized software.
