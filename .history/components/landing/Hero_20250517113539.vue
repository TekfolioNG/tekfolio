  ...
  <main class="relative w-screen h-screen overflow-hidden">
    ...
    <div class="container mx-auto pl-8 md:pl-16 lg:pl-20 pr-4 h-full flex items-center pt-16 relative z-10">
      <div class="max-w-3xl text-white ml-4 md:ml-8">
        ...
        <h1 class="text-3xl md:text-4xl lg:text-5xl sm:text-2xl font-extrabold mb-6">
          <!-- Mobile version (displays only on small screens) -->
          <div class="flex flex-col md:hidden">
            <div class="flex items-center">
              <span ref="wordSwitcherMobile" class="text-blue-300 font-black word-switcher-effect"></span>
              <span class="lowercase">,</span>
            </div>
            <span class="lowercase">customized business</span>
        ...
        <p class="text-lg md:text-xl mt-6 mb-10 leading-relaxed text-white">
          Achieve more with scalable, next-gen websites and apps. Our versed and innovative team
