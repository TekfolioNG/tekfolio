        ...
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6">
          ...
          <div class="flex flex-col md:hidden">
            <div class="flex items-center justify-center space-x-2">
              <span ref="wordSwitcherMobile"
                class="text-blue-300 md:text-blue-300 mobile-blue-text font-black word-switcher-effect text-3xl"></span>
...
/* Mobile optimizations with desaturated blues */
@media (max-width: 768px) {
  ...
  /* Desaturated blue colors for mobile */
  .mobile-blue-text {
    color: #7fb3d9 !important;
    /* More muted blue-300 equivalent */
  }

  .btn-primary {
    background-color: #2a5a94;
    /* Desaturated version of #01348F */
  }
  ...
  .btn-secondary:active {
    background-color: white;
    color: #4a7ba7;
    /* Desaturated version of #1d8ad8 */
    transform: translateY(-2px);
  }

  /* Desaturated text shadows and effects for mobile */
  .word-switcher-effect {
    text-shadow: 0 0 10px rgba(127, 179, 217, 0.5), 0 0 20px rgba(127, 179, 217, 0.3);
    filter: drop-shadow(0 0 8px rgba(116, 164, 200, 0.4));
  }
}
</style>
</content>