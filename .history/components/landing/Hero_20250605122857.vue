        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
          <NuxtLink to="/about" class="btn-primary btn-liquid">
            ...
            <svg class="liquid-wave" viewBox="0 0 100 100" preserveAspectRatio="none">
              <path class="wave-path" d="M0,50 C20,40 50,60 80,50 C100,40 100,50 100,50 L100,100 L0,100 Z" />
            </svg>
          </NuxtLink>
  ...
  liquidButtons.forEach((button) => {
    ...
    button.addEventListener('mouseenter', () => {
      ...
      gsap.to(wavePath, {
        ...
        attr: {
          d: 'M0,50 C20,60 50,40 80,50 C100,60 100,50 100,50 L100,100 L0,100 Z'
        },
        repeat: -1,
        yoyo: true,
        ease: 'sine.inOut'
