<template>
  <main class="relative w-screen h-screen overflow-hidden">
    ...
    <!-- Dot indicators positioned above panel - moved further up -->
    <div class="absolute bottom-36 left-0 right-0 z-30 flex justify-center">
      ...
      <div class="container mx-auto px-6 py-8 text-center">
        <transition name="content-slide" mode="out-in">
          <div :key="'content-' + currentSlide">
            <!-- Category kicker - slightly increased size -->
            <h3 class="text-white/90 text-base md:text-lg font-bold tracking-wider uppercase mb-3">
              {{ slides[currentSlide].category }}
            </h3>
            <!-- Main heading - slightly increased size and very light font -->
            <h2 class="text-white text-2xl md:text-3xl lg:text-4xl font-extralight leading-tight max-w-3xl mx-auto">
    ...
    <!-- Navigation controls - made arrows more visible -->
    <div class="absolute bottom-8 left-0 right-0 z-30 flex justify-between items-center px-8">
      <!-- Previous arrow with more visible background -->
      ...
      <!-- Next arrow with more visible background -->
