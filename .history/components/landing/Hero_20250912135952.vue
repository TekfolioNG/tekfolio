    ...
    <div class="absolute top-0 left-0 right-0 z-30 flex justify-center pt-28 md:pt-32">
      <transition name="button-slide" mode="out-in">
        <NuxtLink :key="'button-' + currentSlide" :to="slides[currentSlide].buttonLink"
          class="px-8 py-3 text-white font-regular transition-all duration-300 text-lg transform hover:scale-105 inline-block find-out-more-btn"
      ...
      <div class="container mx-auto px-6 py-6 text-center">
        <transition name="content-slide" mode="out-in">
          <div :key="'content-' + currentSlide">
            <!-- Category kicker -->
            <h3 class="text-white/90 text-base md:text-lg font-extrabold tracking-wider uppercase mb-2">
              {{ slides[currentSlide].category }}
            </h3>
            <!-- Main heading -->
            <h2 class="text-white text-2xl md:text-3xl lg:text-4xl font-thin leading-tight max-w-3xl mx-auto">
