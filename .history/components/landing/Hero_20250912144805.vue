      ...
      <div class="container mx-auto px-6 py-6 text-center">
        <transition name="content-slide" mode="out-in">
          <div :key="'content-' + currentSlide">
            ...
            <!-- Main heading -->
            <h2
              class="text-white dark:text-gray-100 text-2xl md:text-3xl lg:text-4xl font-thin leading-tight max-w-3xl mx-auto whitespace-nowrap overflow-hidden text-ellipsis">
