      ...
      <div class="container mx-auto px-6 py-6 text-center">
        <transition name="content-slide" mode="out-in">
          <div :key="'content-' + currentSlide">
            <!-- Category kicker -->
            <h3
              class="text-white/90 dark:text-gray-100/90 text-lg md:text-xl font-extrabold tracking-wider uppercase mb-2">
              {{ slides[currentSlide].category }}
            </h3>
            <!-- Main heading -->
            <h2
              class="text-white dark:text-gray-100 text-3xl md:text-4xl lg:text-5xl leading-tight max-w-5xl mx-auto whitespace-nowrap overflow-hidden text-ellipsis"
