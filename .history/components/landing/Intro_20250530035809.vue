    ...
    <div class="container mx-auto max-w-4xl text-center relative">
      ...
      <div class="mx-auto text-gray-900 dark:text-gray-300">
        <p class="text-base md:text-lg lg:text-lg leading-relaxed mb-6">
          ...
          that never quite capture your brand.
        </p>
        <p class="text-base md:text-lg lg:text-lg leading-relaxed mb-6">
          And those 'low-code-no-code' app traps? No backend. No flexibility. No control. No thanks.
        </p>
        <p class="text-base md:text-lg lg:text-lg leading-relaxed mb-6">
          At <b>Tekfolio</b>, we design and create <strong class="text-[#009ADA]">smart, simple, and secure</strong>
          digital solutions— fully custom, from the ground up — tailored to your vision and engineered to scale.

        </p>
        <p class="text-base md:text-lg lg:text-lg leading-relaxed font-semibold">
          No cookie-cutter clones. No vendor lock-ins. No Frankenstein teams. Just performant software that reflects
          your brand’s
