    ...
    <div class="container mx-auto px-6 md:px-8 lg:px-12 relative">
      ...
      <div class="text-center mb-12 md:mb-16">
        ...
        <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight max-w-4xl mx-auto"
          ...
          Turning agricultural waste into clean energy and carbon-fighting solutions
        </h2>

        <!-- Tagline -->
        <div class="mb-8">
          <p class="text-lg md:text-xl text-secondary font-semibold italic">
            Vera Verde means True Green
          </p>
        </div>
      </div>
      ...
      <div class="max-w-5xl mx-auto mb-16">
        <div class="prose prose-lg max-w-none">
          <p class="text-lg md:text-xl text-gray-800 leading-relaxed mb-6">
            ...
            <span class="font-semibold text-primary">clean-burning briquettes</span> and
            <span class="font-semibold text-primary">biochar</span>. Through ecofuel briquettes and biochar,
            we help cut emissions and enrich farmlands by locking carbon directly into the soil.
          </p>

          <p class="text-base md:text-lg text-gray-700 leading-relaxed mb-6">
            Our briquettes provide a <strong>sustainable fuel alternative</strong>, while our biochar helps
            <strong>sequester carbon in the soil</strong>, improving farmland, boosting yields, and
            fighting climate change at the root. We're transforming what was once waste into powerful
            tools for environmental restoration.
          </p>

          <p class="text-base md:text-lg text-gray-700 leading-relaxed mb-6">
            We're not just reducing carbon; we're building <strong>better harvests</strong>,
            <strong>cleaner energy</strong>, and <strong>climate-resilient communities</strong>.
            With the right partners and support, we aim to scale our work toward certified carbon
            credits and greater environmental impact.
          </p>
          ...
          <div class="max-w-3xl mx-auto">
            <div class="bg-primary/10 border-l-4 border-primary p-6 rounded-r-lg">
              <p class="text-base md:text-lg text-gray-800 italic leading-relaxed">
                At Vera Verde, we believe that the solution to climate change lies in working
                with nature, not against it. Every briquette we make and every gram of biochar
                we produce is a step toward a more sustainable future.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center">
          <NuxtLink to="/about-us"
            class="inline-block px-8 py-3 bg-secondary text-white font-medium rounded-lg hover:bg-secondary-dark transition-colors duration-300 shadow-md hover:shadow-lg">
            Learn more about us →
          </NuxtLink>
        </div>
      </div>
...
// Vera Verde focused stats data
const stats = [
  {
    targetValue: 100,
    suffix: "%",
    title: "Agricultural Waste Recycled",
    description: "Transforming rice husk and sawdust into value."
  },
  {
    targetValue: 85,
    suffix: "%",
    title: "Emission Reduction",
    description: "Compared to traditional burning methods."
  },
  {
    targetValue: 2,
    title: "Key Products",
    description: "Ecofuel briquettes and carbon-sequestering biochar."
  },
  {
    targetValue: 50,
    suffix: "%",
    title: "Soil Carbon Increase",
    description: "Biochar locks carbon while enriching farmlands."
  },
  {
    targetValue: 3,
    title: "Climate Benefits",
    description: "Cleaner energy, better harvests, carbon sequestration."
  },
  {
    targetValue: 1,
    title: "True Mission",
    description: "Fighting climate change at the root."
  }
];
