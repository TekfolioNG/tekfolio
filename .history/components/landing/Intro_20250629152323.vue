  ...
  <section class="relative bg-gradient-to-br from-green-50 to-white overflow-hidden">
    ...
    <div class="container mx-auto px-6 md:px-8 lg:px-12 relative z-10 py-16 md:py-24 lg:py-32">
      ...
      <div class="flex items-center justify-center mb-12">
        <div class="w-12 h-0.5 bg-accent mr-4"></div>
        <span class="text-sm uppercase tracking-wider font-medium text-gray-600">
          <b>Vera Verde</b> means True Green.
        </span>
        <div class="w-12 h-0.5 bg-accent ml-4"></div>
      </div>
      ...
      <div class="flex flex-col lg:flex-row items-center gap-12 xl:gap-16">
        ...
        <div class="lg:w-2/5 relative">
          <div class="relative">
            ...
            <div
              class="relative aspect-[4/3] w-full rounded-3xl overflow-hidden shadow-2xl border-4 border-white bg-gradient-to-br from-green-100 via-white to-accent/10 floating-gentle">
              <!-- Image placeholder -->
              <div class="absolute inset-0 flex items-center justify-center">
                <div class="text-center text-gray-400">
                  <div class="text-lg font-medium mb-2">Image Placeholder</div>
                  <div class="text-sm">Your image will go here</div>
                </div>
              </div>
            </div>
