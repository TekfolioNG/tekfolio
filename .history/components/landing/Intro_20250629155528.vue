  ...
  <section class="relative bg-gradient-to-br from-green-50 to-white overflow-hidden">
    ...
    <div class="container mx-auto px-6 md:px-8 lg:px-12 relative z-10 py-16 md:py-24 lg:py-32">
      ...
      <div class="flex items-center justify-center mb-12">
        ...
        <span class="text-base uppercase tracking-wider font-medium text-primary">
      ...
      <div class="flex flex-col lg:flex-row items-center gap-12 xl:gap-16">
        ...
        <div class="lg:w-1/2 space-y-8">
          ...
          <!-- Mission content -->
          <div class="prose max-w-none text-gray-900 space-y-6">
            <p class="text-lg">
            ...
            <div
              ...
              <div class="absolute inset-0 flex">
                ...
                <div class="w-1/2 relative overflow-hidden">
                  ...
                  <div
                    class="absolute bottom-4 left-4 bg-black/60 text-white px-3 py-1 rounded-full text-sm font-medium">
                    Agricultural Waste
                  </div>
                </div>
                ...
                <div class="w-1/2 relative overflow-hidden">
                  <img src="~/assets/img/bio-coal.jpg" alt="Biochar and briquettes climate solution"
                    class="w-full h-full object-cover">
                  <div
                    class="absolute bottom-4 right-4 bg-primary/90 text-white px-3 py-1 rounded-full text-sm font-medium">
                    Climate Solution
                  </div>
                </div>
              </div>
