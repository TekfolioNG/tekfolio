<template>
  ...
  <section class="relative bg-gradient-to-br from-green-50 to-white overflow-hidden">
    ...
    <div class="container mx-auto px-6 md:px-8 lg:px-12 relative z-10 py-16 md:py-24 lg:py-32">
      ...
      <div class="flex flex-col lg:flex-row items-center gap-12 xl:gap-16">
        <!-- Text content -->
        <div class="lg:w-1/2 space-y-8">
          ...
          <div class="bg-gradient-to-r from-primary/5 to-secondary/5 rounded-2xl p-6 border-l-4 border-[#406112]">
        ...
        <!-- Visual element - simplified for image placeholder -->
            ...
            <div
              ...
              <div class="absolute inset-0 flex">
                ...
                <div class="w-1/2 relative overflow-hidden">
                  ...
                  <div
                    class="absolute bottom-2 left-2 md:bottom-4 md:left-4 bg-black/60 text-white px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-medium">
                    Agricultural Waste
                  </div>
                </div>
                ...
                <div class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                  <div class="bg-white rounded-full p-1.5 md:p-2 shadow-lg">
                    <svg class="w-4 h-4 md:w-6 md:h-6 text-primary" fill="none" stroke="currentColor"
                      viewBox="0 0 24 24">
                ...
                <div class="w-1/2 relative overflow-hidden">
                  <img src="/assets/img/bio-coal.jpg" alt="Biochar and briquettes climate solution"
                    class="w-full h-full object-cover">
                  <div
                    class="absolute bottom-2 right-2 md:bottom-4 md:right-4 bg-primary/90 text-white px-2 py-1 md:px-3 md:py-1 rounded-full text-xs md:text-sm font-medium">
                    Climate Solution
                  </div>
                </div>
              </div>
