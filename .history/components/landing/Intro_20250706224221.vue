        ...
        <div class="lg:w-1/2 space-y-6 md:space-y-8">
          ...
          <div class="prose max-w-none text-gray-700 space-y-4 md:space-y-6">
            <p class="text-base md:text-lg">
              At <span class="font-semibold text-primary">Vera Verde</span>Limited
              ...
              solutions, and environmental stewardship. Based in Nigeria, our operations span across
              farming communities, rice mill clusters, and ecofuel processing hubs. We collaborate with
