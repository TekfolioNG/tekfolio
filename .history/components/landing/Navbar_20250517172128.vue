      ...
      <header class="flex items-center justify-between py-2">
        ...
        <nav class="hidden md:flex items-center justify-center absolute left-1/2 transform -translate-x-1/2">
          <ul class="flex items-center">
            <li v-for="item in menuitems" :key="item.title" class="mx-3 lg:mx-4">
            ...
            <li class="ml-8">
              <NuxtLink to="/contact"
                class="px-4 py-2 rounded-md text-sm lg:text-base font-medium whitespace-nowrap transition-colors duration-200"
                :class="[
                  isDark
