  ...
  <div class="fixed w-full z-50 top-0 left-0 right-0 transition-colors duration-300" :class="navbarBackgroundClass">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <header class="flex items-center py-2">
        ...
        <div class="hidden md:flex items-center ml-4"> <!-- Reduced margin here -->
          <NuxtLink to="/contact"
            class="px-4 py-2 rounded-md text-sm lg:text-base font-medium whitespace-nowrap transition-colors duration-200 mr-4"
            <!-- Reduced right margin -->
            :class="[
            isDark
            ? 'bg-white text-blue-700 hover:bg-gray-100' <!-- White background in dark mode -->
