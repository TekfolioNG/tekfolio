...
<template>
  <div class="fixed w-full z-50 top-0 left-0 right-0 transition-colors duration-300" :class="navbarBackgroundClass">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- Mobile Menu - Fixed to ensure it appears below navbar -->
      <transition enter-active-class="transition ease-out duration-200"
        ...
        <div v-show="open" class="md:hidden absolute left-0 right-0 mt-2 py-2 rounded-lg shadow-lg bg-gray-900/90 z-50">
