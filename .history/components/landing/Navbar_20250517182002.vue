...
const menuitems = [
  ...
  { title: "BLOGS & RESOURCES", path: "/blog", hasDropdown: false },
];
  ...
  <div class="fixed w-full z-50 top-0 left-0 right-0 transition-colors duration-300" :class="navbarBackgroundClass">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <header class="flex items-center py-2">
        ...
        <!-- Right-aligned contact button and color toggle - Slightly moved to the left -->
        <div class="hidden md:flex items-center ml-auto pr-8">
          <NuxtLink to="/contact"
        ...
        <div class="md:hidden flex items-center ml-auto">
          ...
          <button @click="open = !open" :class="textColorClass" class="focus:outline-none">
      ...
      <!-- Mobile Menu -->
      <div v-show="open" class="md:hidden mt-2 py-2 rounded-lg shadow-lg bg-gray-900/90 z-50">
