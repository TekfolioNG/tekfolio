...
const navbarBackgroundClass = computed(() => {
  ...
  return isDark.value
    ...
    : 'bg-white/90';   // Light mode scrolled background (90% opacity)
});

// Compute text color based on color mode - always white for menu items
const textColorClass = computed(() => {
  if (isDark.value) {
    return 'text-white';
  }
  return 'text-white'; // Always white text regardless of scroll position
});
