...
// Fixed background - no longer changes based on scroll
...
// Fixed text color - no longer changes based on scroll
...
<template>
  <div class="fixed w-full z-50 top-0 left-0 right-0" :class="navbarBackgroundClass">
