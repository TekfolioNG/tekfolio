...
const navbarBackgroundClass = computed(() => {
  return 'bg-white/10 backdrop-blur-sm border-b border-white/10';
});
      ...
      <header class="flex items-center py-6">
        ...
        <NuxtLink to="/" class="inline-block">
          <img src="~/assets/img/tekfolio-no-tagline.png" alt="Tekfolio Logo"
            class="h-10 md:h-12 drop-shadow-2xl logo-mobile-desaturated transition-all duration-200 hover:scale-105" />
        </NuxtLink>
            ...
            <ul class="flex space-x-6 lg:space-x-8">
              <li v-for="item in menuitems" :key="item.title">
                <NuxtLink :to="item.path"
                  class="text-sm lg:text-base transition-colors duration-200 flex items-center whitespace-nowrap font-medium drop-shadow-sm"
                  :class="[
                    textColorClass,
                    'hover:text-[#1d8ad8]'
                  ]">
