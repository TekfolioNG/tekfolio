      ...
      <div class="px-4 py-4 space-y-4">
        ...
        <div>
          ...
          <div v-show="activeMobileDropdown === 'whoWeAre'" class="mt-2 ml-4 space-y-2">
            <NuxtLink to="/about" class="block text-secondary-700 dark:text-gray-300 py-1">About Us</NuxtLink>
            <NuxtLink to="/team" class="block text-secondary-700 dark:text-gray-300 py-1">Our Team</NuxtLink>
            <NuxtLink to="/history" class="block text-secondary-700 dark:text-gray-300 py-1">Company History</NuxtLink>
          </div>
        </div>
          ...
          <div v-show="activeMobileDropdown === 'solutions'" class="mt-2 ml-4 space-y-3">
            <div>
              ...
              <div class="ml-2 space-y-1">
                <NuxtLink to="/solutions/equipment-maintenance"
                  class="block text-secondary-700 dark:text-gray-300 text-sm py-1">Equipment Maintenance</NuxtLink>
                <NuxtLink to="/solutions/project-management"
                  class="block text-secondary-700 dark:text-gray-300 text-sm py-1">Project Management</NuxtLink>
              </div>
            </div>
            <div>
              ...
              <div class="ml-2 space-y-1">
                <NuxtLink to="/solutions/turnkey-solutions"
                  class="block text-secondary-700 dark:text-gray-300 text-sm py-1">Turnkey Solutions</NuxtLink>
                <NuxtLink to="/solutions/industrial-installations"
                  class="block text-secondary-700 dark:text-gray-300 text-sm py-1">Industrial
                  Installations</NuxtLink>
              </div>
            </div>
            <div>
              ...
              <div class="ml-2 space-y-1">
                <NuxtLink to="/solutions/corrosion-management"
                  class="block text-secondary-700 dark:text-gray-300 text-sm py-1">Corrosion Management</NuxtLink>
                <NuxtLink to="/solutions/asset-integrity"
                  class="block text-secondary-700 dark:text-gray-300 text-sm py-1">Asset Integrity</NuxtLink>
                <NuxtLink to="/solutions/manpower-services"
                  class="block text-secondary-700 dark:text-gray-300 text-sm py-1">Manpower Services</NuxtLink>
                <NuxtLink to="/solutions/tank-vessel-cleaning"
                  class="block text-secondary-700 dark:text-gray-300 text-sm py-1">Tank & Vessel Cleaning</NuxtLink>
              </div>
            </div>
            <div>
              ...
              <div class="ml-2 space-y-1">
                <NuxtLink to="/solutions/petrochemical-processing"
                  class="block text-secondary-700 dark:text-gray-300 text-sm py-1">Petrochemical
                  Processing</NuxtLink>
                <NuxtLink to="/solutions/downstream-operations"
                  class="block text-secondary-700 dark:text-gray-300 text-sm py-1">Downstream Operations</NuxtLink>
                <NuxtLink to="/solutions/marine-operations"
                  class="block text-secondary-700 dark:text-gray-300 text-sm py-1">Marine Operations</NuxtLink>
                <NuxtLink to="/solutions/supply-chain" class="block text-secondary-700 dark:text-gray-300 text-sm py-1">
        ...
        <div>
          ...
          <div v-show="activeMobileDropdown === 'commitment'" class="mt-2 ml-4 space-y-2">
            <NuxtLink to="/commitment/safety" class="block text-secondary-700 dark:text-gray-300 py-1">Safety</NuxtLink>
            <NuxtLink to="/commitment/quality" class="block text-secondary-700 dark:text-gray-300 py-1">Quality
            </NuxtLink>
            <NuxtLink to="/commitment/csr" class="block text-secondary-700 dark:text-gray-300 py-1">CSR (Oaktree
              Initiative)</NuxtLink>
            <NuxtLink to="/commitment/sustainability" class="block text-secondary-700 dark:text-gray-300 py-1">
              Sustainability</NuxtLink>
          </div>
        </div>
