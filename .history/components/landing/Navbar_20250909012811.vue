  ...
  <nav
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-20">
            ...
            <div v-show="activeDropdown === 'solutions'"
              ...
              <div class="space-y-1 px-2">
                ...
                <div
                  ...
                  <div>
                    <h4
                      class="font-semibold text-secondary-900 dark:text-secondary-100 group-hover/item:text-primary-600 dark:group-hover/item:text-primary-400">
                      Engineering</h4>
        ...
        <div class="flex items-center space-x-4">
          ...
          <NuxtLink to="/contact"
            class="hidden lg:inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 text-white font-medium rounded-lg transition-colors duration-200">
            Contact Us
          </NuxtLink>
    ...
    <div v-show="mobileMenuOpen"
      ...
      <div class="px-4 py-6 space-y-6">
          ...
          <div v-show="activeMobileDropdown === 'commitment'" class="mt-3 ml-4 space-y-3">
            <div class="flex items-center space-x-3 py-1">
              ...
              <NuxtLink to="/commitment/safety"
                class="text-secondary-700 dark:text-secondary-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                Safety</NuxtLink>
            </div>
            <div class="flex items-center space-x-3 py-1">
              <StarIcon class="w-5 h-5 text-primary-600 dark:text-primary-400" />
        ...
        <!-- Mobile Contact Us -->
        <NuxtLink to="/contact"
          class="block w-full text-center px-4 py-3 bg-primary-600 hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 text-white font-medium rounded-lg transition-colors duration-200">
          Contact Us</NuxtLink>
      </div>
    </div>
  </nav>
