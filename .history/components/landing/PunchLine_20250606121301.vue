            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="lg:pl-12">
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                        ...
                        team. The result? Happy users, higher satisfaction, and better loyalty.
                    </p>

                    <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                        That's because we're more than just your dev team. We're your growth partners, building e-smart
                        solutions that are technically sound, easy to use, and fully secure to power your success.
                    </p>
