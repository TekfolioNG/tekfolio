            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="lg:pl-12">
                    <h1
                        ...
                        Build unique, functional apps <span
                            class="bg-gradient-to-r from-[#3b82f6] to-[#06b6d4] bg-clip-text text-transparent"><br>that
                            fit like notes in harmony<br></span>
                    </h1>
                    ...
                    <p class="text-lg text-gray-900 dark:text-gray-300 mb-8 leading-relaxed">
