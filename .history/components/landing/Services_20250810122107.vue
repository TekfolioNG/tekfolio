<template>
    <section class="py-16 md:py-24 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white w-full">
        <div class="container mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
            ...
            <div class="text-center mb-16">
                ...
                <h1
                    ...
                    Our full <span
                        class="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent dark:text-blue-400">'tekfolio'</span>
                    of services
                </h1>
