    ...
    <section class="py-16 md:py-24 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-6 md:gap-8">
                ...
                <div class="flex flex-col items-center text-center">
                    <NuxtLink to="#" class="group block">
                        <div class="mb-4 bob-animation" style="animation-delay: 3s;">
                ...
                <div class="flex flex-col items-center text-center">
                    <NuxtLink to="#" class="group block">
                        <div class="mb-4 bob-animation" style="animation-delay: 9s;">
                ...
                <div class="flex flex-col items-center text-center">
                    <NuxtLink to="#" class="group block">
                        <div class="mb-4 bob-animation" style="animation-delay: 12s;">
