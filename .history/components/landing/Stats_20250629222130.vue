                        ...
                        <div
                            ...
                            <div class="flex items-start space-x-4">
                                <div class="flex-shrink-0 relative">
                                    <div
                                        class="w-14 h-14 bg-[#99cc33] rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                    ...
                                    <!-- Pulse animation dot -->
                                    <div
                                        class="absolute -top-1 -right-1 w-4 h-4 bg-[#99cc33] rounded-full animate-pulse">
                                    </div>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <div class="text-3xl md:text-3xl font-bold bg-[#99cc33] bg-clip-text text-transparent mb-2"
                                        ref="stat1">0</div>
