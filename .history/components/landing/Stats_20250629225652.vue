            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
                ...
                <div class="order-2 lg:order-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <!-- Stat 1 -->
                        <div
                            class="group bg-white rounded-2xl p-2 shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:border-primary/20">
