                    ...
                    <div class="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                        <div class="mb-8">
                            <div class="flex items-center space-x-3 mb-4">
                                <div
                                    class="w-12 h-12 bg-gradient-to-br from-green-600 to-green-800 rounded-xl flex items-center justify-center">
                        ...
                        <!-- Enhanced SDG Grid - 2 columns on all screen sizes -->
                        <div class="grid grid-cols-2 gap-6">
                            <!-- SDG 13: Climate Action -->
                            <div class="group cursor-pointer transition-all duration-300 hover:-translate-y-2">
                                <div
                                    class="relative bg-gradient-to-br from-green-600 to-green-800 rounded-2xl p-6 shadow-lg group-hover:shadow-2xl transition-all duration-300">
                                    <!-- Glow effect on hover -->
                                    <div
                                        class="absolute inset-0 bg-gradient-to-br from-green-600 to-green-800 rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300">
                                    </div>

                                    <div class="relative">
                                        <!-- Number and Icon on same line -->
                                        <div class="flex items-center space-x-2 mb-3">
                                            <span class="text-2xl font-bold text-white">13.</span>
                                            <Icon name="heroicons:sun" class="w-6 h-6 text-white flex-shrink-0" />
                                        </div>
                                        <!-- Text below -->
                                ...
                                <div
                                    ...
                                    <div class="relative">
                                        <div class="flex items-center space-x-2 mb-3">
                                            ...
                                            <Icon name="heroicons:leaf" class="w-6 h-6 text-white flex-shrink-0" />
                                        </div>
                                        <p class="text-white/90 font-medium text-sm leading-relaxed">
                                            Life on Land
                                        </p>
                                ...
                                <div
                                    ...
                                    <div class="relative">
                                        <div class="flex items-center space-x-2 mb-3">
                                            ...
                                            <Icon name="heroicons:heart" class="w-6 h-6 text-white flex-shrink-0" />
                                        </div>
                                        <p class="text-white/90 font-medium text-sm leading-relaxed">
                                            Zero Hunger
                                        </p>
                                ...
                                <div
                                    ...
                                    <div class="relative">
                                        <div class="flex items-center space-x-2 mb-3">
                                            ...
                                            <Icon name="heroicons:briefcase" class="w-6 h-6 text-white flex-shrink-0" />
                                        </div>
                                        <p class="text-white/90 font-medium text-sm leading-relaxed">
                                            Decent Work
                                        </p>
                                ...
                                <div
                                    ...
                                    <div class="relative">
                                        <div class="flex items-center space-x-2 mb-3">
                                            ...
                                            <Icon name="heroicons:bolt" class="w-6 h-6 text-white flex-shrink-0" />
                                        </div>
                                        <p class="text-white/90 font-medium text-sm leading-relaxed">
                                            Clean Energy
                                        </p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-sm text-gray-900 leading-relaxed mb-0">Through biochar and sustainable
                                    land use</p>
                            </div>
                        </div>
