                    ...
                    <div class="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                        ...
                        <div class="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                            ...
                            <div class="grid grid-cols-2 gap-4 max-w-md mx-auto">
                                ...
                                <div
                                    class="group cursor-pointer transition-all duration-300 hover:-translate-y-2 w-32 mx-auto">
                                    <div
                                        class="relative bg-gradient-to-br from-green-600 to-green-800 rounded-xl p-3 shadow-lg group-hover:shadow-2xl transition-all duration-300">
                                        ...
                                        <div class="relative">
                                            ...
                                            <!-- Text below -->
                                            <p class="text-white/90 font-medium text-xs leading-tight">
                                                Climate<br>Action
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="group cursor-pointer transition-all duration-300 hover:-translate-y-2">
                                    <div
                                        class="relative bg-gradient-to-br from-green-600 to-green-800 rounded-xl p-4 shadow-lg group-hover:shadow-2xl transition-all duration-300">
                                        <div
                                            class="absolute inset-0 bg-gradient-to-br from-green-600 to-green-800 rounded-xl opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300">
                                        </div>
