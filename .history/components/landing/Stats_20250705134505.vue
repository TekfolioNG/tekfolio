<template>
    <!-- Impact Section -->
    <section class="relative bg-gradient-to-br from-gray-50 to-white py-16 md:py-24 overflow-hidden mt-0 -md:mt-18">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
                ...
                <div class="order-1 lg:order-1 space-y-12">
                    ...
                    <div class="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                        ...
                        <!-- Enhanced SDG Grid - Sequential order with mobile responsive margins -->
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-12 md:gap-6 max-w-2xl mx-auto px-4 md:px-0">
                            <!-- SDG 1: No Poverty -->
                            <div
                                ...
                                <div
                                    ...
                                    <div class="relative">
                                        <div class="flex items-center space-x-2 mb-2">
                                            ...
                                            <Icon name="mdi:leaf" class="w-5 h-5 text-white flex-shrink-0" />
                                        </div>
                                        <h4 class="text-white/90 font-medium text-xs whitespace-nowrap"><b>
                                                Life on Land
                                            </b></h4>
