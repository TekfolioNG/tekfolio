            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
                ...
                <div class="order-2 lg:order-2">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 justify-items-center sm:justify-items-start">
                        ...
                        <!-- Continue this pattern for all other stats... -->
                        <!-- Each stat card needs these classes: -->
                        <!-- Card container: "w-full max-w-sm sm:max-w-none text-center sm:text-left" -->
                        <!-- Icon+Number flex container: "flex items-center justify-center sm:justify-start space-x-4 mb-2" -->
