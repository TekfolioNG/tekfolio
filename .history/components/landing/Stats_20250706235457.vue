                        ...
                        <div
                            ...
                            <div class="flex items-center justify-center sm:justify-start space-x-4 mb-2">
                                <div class="flex-shrink-0 relative">
                                    ...
                                    <div
                                        class="absolute -top-1 -right-1 w-4 h-4 gradient-to-br from-[#2d420c] to-[#406112] rounded-full animate-pulse">
                                    </div>
                                </div>
                                <div class="text-3xl md:text-3xl font-bold gradient-to-br from-[#2d420c] to-[#406112] bg-clip-text text-transparent"
                                    ref="stat2">0</div>
                            </div>
                            <div class="space-y-2">
