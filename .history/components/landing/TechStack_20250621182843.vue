                ...
                <div class="lg:col-span-3">
                    <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 gap-8">
                        <div v-for="tech in allTechs" :key="tech.name"
                            ...
                            <span
                                class="text-sm font-medium text-gray-600 dark:text-gray-400 text-center group-hover:text-gray-900 dark:group-hover:text-gray-200 transition-colors">
                                {{ tech.name }}
                            </span>
                        </div>
                    </div>
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    <div
                        ...
                        <div
                            ...
                            <img src="/img/googlecloud.png" alt="Google Cloud" class="w-10 h-10 object-contain" />
                        </div>
                        <div>
                    ...
                    <div
                        ...
                        <div
                            class="w-16 h-16 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center mr-6 shadow-md">
                            <img src="/img/googlecyber.png" alt="Google Cybersecurity"
...
const allTechs = computed(() => [
    ...
    { name: 'Google Cloud', image: '/img/googlecyber.png' },
    { name: 'Google Cloud', image: '/img/googlecloud.png' },
