                    ...
                    <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 gap-8">
                        <div v-for="tech in allTechs" :key="tech.name"
                            ...
                            <div :class="[
                                ...
                                <img :src="tech.image" :alt="tech.name" :class="[
                                    'w-full h-full object-contain group-hover:grayscale transition-all duration-300',
                                    isGoogleCert(tech.image) ? 'shadow-lg shadow-gray-400/50 dark:shadow-gray-700/50 rounded-lg' : ''
                                ]" loading="lazy" />
                            </div>
                        </div>
                    </div>
...
const allTechs = computed(() => [
    ...
    { name: 'Google Cyber', image: '/img/googlecyber.png' },
