<template>
    <section
        ...
        <div class="container mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative mb-16">
                <div class="text-center mb-12">
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold mb-6">
                        Why We're the Go-To Tech Partner <br>for Ambitious Brands</br>
                    </h2>
                    <div class="w-24 h-1 bg-[#01348F] mb-6 mx-auto"></div>
                    <p class="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed max-w-4xl mx-auto">
            ...
            <!-- Service Cards - First Row (2 cards + image) -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10 mb-12 px-4 sm:px-0">
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-back">
                                <div
                                    class="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl border border-gray-200 dark:border-gray-700 transition-all duration-300 h-full flex flex-col">
                                    <p
                                        class="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed flex-grow text-center">
                                        From the first commit to launch day, we move fast and ship clean, scalable code
                                        you won't
                                        need to rebuild in six months.
                                    </p>
                                    <NuxtLink to="/services"
                                        class="flex items-center justify-center text-[#01348F] dark:text-blue-400 cta-link hover:text-blue-600 dark:hover:text-blue-300">
                ...
                <div class="feature-card">
                    <div
                        class="bg-gray-50 dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 h-full flex items-center justify-center">
                        <img src="~/assets/img/why-tekfolio.png" alt="Tekfolio value proposition"
                            class="rounded-lg shadow-lg w-full h-auto object-cover dark:invert transition-all duration-300"
                            loading="lazy" />
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-back">
                                <div
                                    ...
                                    <p
                                        class="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed flex-grow text-center">
                                        From Nuxt to Flutter and even Vertex AI, we use cutting-edge tools to craft
                                        experiences that
                                        put users first.
                                    </p>
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-front">
                                <div
                                    ...
                                    <h3 class="text-xl font-bold mb-3 text-center">A True Partner, Not Just a Vendor
                                    </h3>
                            ...
                            <div class="card-back">
                                <div
                                    ...
                                    <p
                                        class="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed flex-grow text-center">
                                        We ask better questions, suggest smarter solutions, and stay engaged long after
                                        launch. You
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-back">
                                <div
                                    ...
                                    <p
                                        class="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed flex-grow text-center">
                                        Whether you're launching an MVP or scaling a full product with payments and
                                        multi-role
                                        access, we design systems that grow with your business.
                                    </p>
                                    <NuxtLink to="/scalability"
                                        class="flex items-center justify-center text-[#01348F] dark:text-blue-400 cta-link hover:text-blue-600 dark:hover:text-blue-300">
                                        <span class="mr-2 font-bold">Learn More</span>
                                        <Icon name="lucide:arrow-right" class="w-5 h-5 cta-arrow" />
                                    </NuxtLink>
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-back">
                                <div
                                    ...
                                    <p
                                        class="text-lg text-gray-600 dark:text-gray-300 mb-6 leading-relaxed flex-grow text-center">
                                        You'll always know what's happening. We break projects into clear stages with
                                        honest
...
<script setup>
// Enhanced component with card flip functionality
</script>
...
.feature-card>.card-container>.card-inner>div>div {
    transition: all 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94);
}
...
.feature-card:hover .card-front>div,
.feature-card:hover .card-back>div {
...
.feature-card:not(:hover):not(:focus):not(:active) .card-inner {
    transition: transform 0.8s cubic-bezier(0.25, 0.46, 0.45, 0.94);
}
