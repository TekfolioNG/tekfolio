                    ...
                    <div class="card-container">
                        <div class="card-inner">
                            ...
                            <div class="card-front">
                                <div
                                    class="bg-white p-4 rounded-xl border border-gray-200 h-full flex items-center justify-center">
                                    <img src="~/assets/img/why-tekfolio.png" alt="Tekfolio value proposition"
                                        class="rounded-lg shadow-lg w-full h-auto object-cover transition-all duration-300"
                                        loading="lazy" />
                                </div>
                            </div>
                            <!-- Back Side -->
                            <div class="card-back">
                                <div
                                    class="bg-gray-800 p-4 rounded-xl border border-gray-600 h-full flex items-center justify-center">
                                    <img src="~/assets/img/tek-logo.png" alt="Tekfolio Logo"
                                        class="rounded-lg shadow-lg w-full h-auto object-cover transition-all duration-300"
                                        loading="lazy" />
                                </div>
                            </div>
                                ...
                                <div
                                    ...
                                    <div class="flex-grow flex items-center justify-center">
                                        <p
                                            ...
                                            From the first commit to launch day, we move fast and ship clean, scalable
                                            code
                                            you won't
                            ...
                            <div class="card-back">
                                <div
                                    ...
                                    <div class="flex-grow flex items-center justify-center">
                                        <p
                                            class="text-lg text-gray-800 dark:text-gray-200 mb-6 leading-relaxed text-center">
                                            We always start with your business goals in mind. Then we ask about and
                                            analyze your users, as well as your long-term vision. We make sure every
                                            decision maps to what actually matters.
                                        </p>
                                    </div>
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-front">
                                <div
                                    ...
                                    <h3 class="text-xl font-bold mb-3 text-center">Althought we're so much about tech,
                                        <br>we're human-centered</br>
                                    </h3>
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-front">
                                <div
                                    ...
                                    <h3 class="text-xl font-bold mb-3 text-center">We aim to be true business partners,
                                        <br>not just another vendor
                                        </br>
                                    </h3>
                            ...
                            <div class="card-back">
                                <div
                                    ...
                                    <div class="flex-grow flex items-center justify-center">
                                        <p
                                            class="text-lg text-gray-800 dark:text-gray-200 mb-6 leading-relaxed text-center">
                                            We ask better questions, suggest smarter solutions, and stay engaged long
                                            after
                                            launch. You
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-front">
                                <div
                                    ...
                                    <h3 class="text-xl font-bold mb-3 text-center">We build for your organizational
                                        <br>growth and
                                        change</br>
                                    </h3>
                            ...
                            <div class="card-back">
                                <div
                                    ...
                                    <div class="flex-grow flex items-center justify-center">
                                        <p
                                            class="text-lg text-gray-800 dark:text-gray-200 mb-6 leading-relaxed text-center">
                                            Launching an MVP? Or scaling a full product with payments and
                                            multi-role
                                            access? Whatever stage you are at, we design systems that grow with your
                                            business.
                                        </p>
                                    </div>
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-front">
                                <div
                                    ...
                                    <h3 class="text-xl font-bold mb-3 text-center">Structured, agile process</h3>
                            ...
                            <div class="card-back">
                                <div
                                    ...
                                    <div class="flex-grow flex items-center justify-center">
                                        <p
                                            class="text-lg text-gray-800 dark:text-gray-200 mb-6 leading-relaxed text-center">
                                            You'll always know what's happening. We break projects into clear stages
                                            with
                                            honest
                            ...
                            <div class="card-back">
                                <div
                                    ...
                                    <div class="flex-grow flex items-center justify-center">
                                        <p
                                            class="text-lg text-gray-800 dark:text-gray-200 mb-6 leading-relaxed text-center">
                                            We respect timelines and deliver when promised, without compromising quality
                                            or
                                            momentum.
...
.feature-card {
    ...
    box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.3), 0 2px 4px -1px rgba(0, 0, 0, 0.08);
}
