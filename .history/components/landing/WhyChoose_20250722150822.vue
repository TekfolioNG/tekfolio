                                ...
                                <div
                                    ...
                                    <div class="flex-grow flex items-center justify-center">
                                        <p
                                            ...
                                            competitive edge that amplifies your brand. As your tech partner, we ensure
                                            you're not just keeping pace but setting the pace. We’ll help your brand pop
                                            in crowded markets and leave competitors playing catch-up.
                                        </p>
                                    </div>
                                    <NuxtLink to="/case-studies"
                                        class="flex items-center justify-center text-[#01348F] dark:text-blue-400 cta-link hover:text-blue-600 dark:hover:text-blue-300 mt-auto">
