            ...
            <div class="relative mb-16">
                <div class="text-center mb-12 max-w-3xl mx-auto">
                    ...
                    <p class="text-lg text-gray-900 dark:text-gray-300 mb-6 leading-relaxed">
                        We work with teams that think ahead, move fast, and build with purpose. From
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-front">
                                <div
                                    ...
                                    <h3 class="text-2xl font-bold mb-3 text-center barlow-condensed">Security without
                                        <br>the headaches
                                        </br>
                                    </h3>
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-front">
                                <div
                                    ...
                                    <h3 class="text-2xl font-bold mb-3 text-center barlow-condensed">Your vision becomes
                                        <br>our mission</br>
                                    </h3>
                        ...
                        <div class="card-inner">
                            ...
                            <div class="card-front">
                                <div
                                    ...
                                    <h3 class="text-2xl font-bold mb-3 text-center barlow-condensed">Tekfolio means
                                        digital
