<template>
    <!-- CTA Section -->
    <section class="relative bg-gradient-to-br from-amber-50 to-green-50 py-12 md:py-16 overflow-hidden">
        <!-- Background Pattern -->
        ...
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute -top-24 -right-24 w-96 h-96 bg-[#fe4135]/10 rounded-full blur-3xl"></div>
        ...
        <div class="container mx-auto px-6 md:px-8 lg:px-12 relative z-10">
            <div class="max-w-6xl mx-auto">
                <div class="grid lg:grid-cols-3 gap-8 items-center">
                    <!-- Left Column: Image -->
                    <div
                        class="col-span-3 lg:col-span-1 relative flex justify-center lg:justify-start order-2 lg:order-1">
                        <div class="relative group max-w-xs lg:max-w-sm">
                            <!-- Main Image -->
                            <div class="relative">
                                <img src="/assets/img/engineer2.png" alt="Syntanium Energy - Engineering Solutions"
                                    class="w-full h-auto rounded-xl shadow-lg transform group-hover:scale-105 transition-transform duration-700" />
                            </div>

                            <!-- Floating Elements -->
                            <div
                                class="absolute -top-4 -right-4 w-12 h-12 bg-white/90 rounded-full flex items-center justify-center shadow-lg animate-bounce">
                    ...
                    <div class="col-span-3 lg:col-span-2 text-center lg:text-left order-1 lg:order-2">
                        <div class="max-w-2xl mx-auto lg:mx-0">
                            ...
                            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-6 leading-tight">
                                Power Tomorrow
                                <span class="text-[#fe4135]">with Us</span>
                            </h2>

                            <!-- Description -->
                            <p class="text-lg md:text-xl text-gray-700 mb-6 leading-relaxed">
                                At Syntanium, we provide solutions that keep industries moving with safety, quality, and
                                sustainability at the core. From engineering and construction to long-term maintenance,
                                our expertise helps partners achieve lasting results.
                            </p>
