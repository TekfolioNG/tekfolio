<template>
    ...
    <section
        ...
        <div class="absolute inset-0 overflow-hidden">
            <div
                class="absolute -top-24 -right-24 w-96 h-96 bg-[#fe4135]/10 dark:bg-[#fe4135]/20 rounded-full blur-3xl">
            </div>
            <div
                class="absolute -bottom-24 -left-24 w-96 h-96 bg-amber-200/10 dark:bg-amber-400/20 rounded-full blur-3xl">
            </div>
        </div>
                ...
                <div class="grid lg:grid-cols-5 gap-8 items-center">
                    ...
                    <div class="col-span-5 lg:col-span-3 text-center lg:text-left order-2 lg:order-1">
                        <div class="max-w-2xl mx-auto lg:mx-0">
                            ...
                            <!-- Heading -->
                            <h2
                                class="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 dark:text-white mb-6 leading-tight">
                                Power Tomorrow
