<template>
    <div class="min-h-screen bg-white dark:bg-gray-900 flex flex-col relative overflow-hidden">
        ...
        <div
            class="absolute inset-0 flex items-center justify-center pointer-events-none transform translate-x-12 -translate-y-16 z-0">
            <span
                class="text-[27rem] md:text-[38rem] font-barlow font-bold text-gray-100 dark:text-gray-800 select-none opacity-20 tracking-wider">
                404
            </span>
        </div>
        ...
        <main class="flex-1 flex items-center justify-center px-4 md:px-8 py-12 relative z-10">
            <div class="max-w-4xl w-full">
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="flex justify-center lg:justify-end order-1 lg:order-2 relative">
