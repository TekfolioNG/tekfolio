<template>
    <div class="min-h-screen bg-white dark:bg-gray-900 flex flex-col relative overflow-hidden">
        ...
        <div
            class="absolute inset-0 flex items-center justify-center pointer-events-none transform translate-x-64 -translate-y-40 z-0">
            <span
                class="text-[40rem] md:text-[55rem] lg:text-[65rem] font-barlow font-bold text-gray-100 dark:text-gray-800 select-none opacity-20 tracking-wider">
                404
            </span>
        </div>
