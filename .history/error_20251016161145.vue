                ...
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="content-column">
                        ...
                        <h1 class="main-heading">
                            Oops... This Page Didn’t Make the Strategy Deck
                        </h1>

                        <!-- Body Text -->
                        <div class="body-text">
                            <p>
                                We couldn’t find the page you’re looking for. It returned an <strong
                                    class="text-[#00D4FF]">error 404,</strong> which means it may have
                                been moved, renamed, or no longer exists.
                            </p>
                            <p class="text-lg md:text-xl font-medium text-white">
                                Either way, let’s help you get back to where you need to be.
                            </p>
                        </div>
                    ...
                    <div class="animation-column">
                        ...
                        <div class="faded-404-container">
                            <span class="faded-404-text">
                                404
                            </span>
                        </div>

                        <!-- Lottie Animation -->
                        <DotLottieVue style="height: 800px; width: 800px" autoplay loop
...
/* Large Background 404 - Increased size and repositioned */
.large-bg-404 {
    position: absolute;
    inset: 0;
    display: flex;
    ...
    pointer-events: none;
    z-index: 0;
    transform: translate(16rem, -10rem) !important;
}
...
/* Button Wrapper - Centered on mobile */
.button-wrapper {
    display: flex;
    justify-content: center;
...
/* Faded 404 behind animation - Increased size and repositioned */
.faded-404-container {
