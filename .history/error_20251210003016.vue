<template>
    <div class="min-h-screen bg-white flex flex-col relative overflow-hidden">
        ...
        <header class="relative z-20 p-6 md:p-8">
            <NuxtLink to="https://tekfolio.ng" class="logo-mobile-center">
                <div class="max-w-7xl mx-auto flex justify-center">
                    <img src="/tekfolio.svg" alt="Tekfolio Logo" class="h-16 md:h-16" />
                </div>
            </NuxtLink>
        </header>
        ...
        <div class="flex-1 flex items-center justify-center relative">
            ...
            <div class="relative z-10 max-w-6xl mx-auto px-8 md:px-16 lg:px-24 w-full">
                <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div class="space-y-6">
                        <!-- Heading -->
                        <h1 class="text-3xl md:text-5xl lg:text-5xl font-black text-gray-900 leading-tight">
                            You've reached a dead end.
                        </h1>

                        <!-- Body Text -->
                        <div class="text-sm md:text-base lg:text-lg text-gray-700 space-y-3 leading-relaxed">
                            <p>
                    ...
                    <div class="flex justify-center lg:justify-end relative">
                        ...
                        <div class="relative w-80 h-80 md:w-96 md:h-96">
                            ...
                            <div class="relative z-10 w-full h-full flex items-center justify-center">
                                <img src="/404.png" alt="404 - Page Not Found" class="w-full h-full object-contain" />
                            </div>
                        </div>
                    </div>
                </div>
