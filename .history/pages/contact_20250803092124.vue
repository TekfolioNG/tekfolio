...
<template>
  <div
    ...
    <!-- Hero Section -->
    <section
      class="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-orange-900/10 via-orange-800/5 to-amber-900/10 dark:from-orange-900/30 dark:via-orange-800/20 dark:to-amber-900/30">
      <!-- Decorative Elements -->
      ...
      <div class="relative container mx-auto px-6 xl:px-16 2xl:px-24">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-12 items-center max-w-7xl mx-auto">
          <!-- Left Content -->
