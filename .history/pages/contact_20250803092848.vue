...
<template>
  <div
    ...
    <!-- Hero Section -->
    <section
      class="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-orange-900/40 via-orange-800/30 to-amber-900/35 dark:from-orange-900/60 dark:via-orange-800/50 dark:to-amber-900/55">
      <!-- Decorative Elements -->
      <div class="absolute inset-0 overflow-hidden">
        <div
          class="absolute -top-40 -right-40 w-80 h-80 rounded-full bg-gradient-to-br from-[#F4A460]/30 to-transparent blur-3xl">
        </div>
        <div
          class="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-gradient-to-tr from-amber-300/40 to-transparent blur-3xl">
        </div>
      </div>
