...
<template>
  <div
    ...
    <!-- Hero Section -->
    <section
      class="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-orange-900/60 via-orange-800/50 to-amber-900/55">
      <!-- Decorative Elements -->
      ...
      <div class="relative container mx-auto px-8 lg:px-16 xl:px-20 2xl:px-32">
        <div
          ...
          <div class="text-center lg:text-left">
            ...
            <!-- Quick Stats -->
            <div class="grid grid-cols-3 gap-8 pt-8 border-t border-gray-300">
