...
<template>
  <div
    ...
    <!-- Hero Section -->
    <section class="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-orange-900 via-amber-900 to-orange-800">
      <!-- Decorative Elements -->
      <div class="absolute inset-0 overflow-hidden">
        <div
          class="absolute -top-40 -right-40 w-80 h-80 rounded-full bg-gradient-to-br from-orange-700/40 to-transparent blur-3xl">
        </div>
        <div
          class="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-gradient-to-tr from-amber-700/40 to-transparent blur-3xl">
        </div>
      </div>
      ...
      <div class="relative container mx-auto px-8 lg:px-16 xl:px-20 2xl:px-32">
        <div
          ...
          <div class="text-center lg:text-left">
            ...
            <p class="text-xl text-orange-100 mb-8 max-w-lg">
              Ready to start a conversation? We're here to listen, help, and turn your ideas into reality.
            </p>

            <!-- Quick Stats -->
            <div class="grid grid-cols-3 gap-8 pt-8 border-t border-orange-700">
              <div class="text-center">
                <div class="text-2xl font-bold text-[#F4A460] mb-1">24h</div>
                <div class="text-sm text-orange-200">Response Time</div>
              </div>
              <div class="text-center">
                <div class="text-2xl font-bold text-[#F4A460] mb-1">500+</div>
                <div class="text-sm text-orange-200">Happy Clients</div>
              </div>
              <div class="text-center">
                <div class="text-2xl font-bold text-[#F4A460] mb-1">99%</div>
                <div class="text-sm text-orange-200">Satisfaction</div>
              </div>
            </div>
          </div>
