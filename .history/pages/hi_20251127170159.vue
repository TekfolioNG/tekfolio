            ...
            <div class="container mx-auto px-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    ...
                    <div
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mb-4">Send us an email and we'll respond within 24
                            hours</p>
                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="text-center mb-16">
                        ...
                        <p class="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                            Have a question or want to discuss a project? Fill out the form below and we'll get back to
                            you as soon as
                            possible.
                        </p>
                    </div>
                        ...
                        <div
                            ...
                            <form @submit="submitForm" class="space-y-8" novalidate>
                                ...
                                <div class="group">
                                    ...
                                    <div class="relative">
                                        <textarea id="message" name="message" v-model="formData.message" rows="6"
                                ...
                                <Transition name="slide-fade" mode="out-in">
                                    <div v-if="formStatus.message" :class="{
                                        ...
                                        <div class="flex items-center">
                                            <svg v-if="formStatus.success" class="w-5 h-5 mr-3 flex-shrink-0"
                                                fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                                                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                                                    clip-rule="evenodd"></path>
                                            </svg>
                                            <svg v-else-if="formStatus.error" class="w-5 h-5 mr-3 flex-shrink-0"
                                                fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd"
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-gray-900 dark:text-gray-300 pl-5">
                                    Yes! We offer complimentary initial consultations to discuss your needs and how we
                                    can help achieve
                                    your goals.
                                </p>
                            </div>
